package cmodule.lua_wrapper
{
   ...
   public class CSystemLocal extends Object implements CSystem
   {
      ...
      public function CSystemLocal(param1:Boolean=false) {
         ...
         CSystemLocal.width = CSystemLocal?CSystemLocal.stage.stageWidth:800;
         CSystemLocal.height = CSystemLocal?CSystemLocal.stage.stageHeight:600;
      ...
      public function open(param1:int, param2:int, param3:int) : int {
         ...
         _loc4_ = CSystemLocal.gworker.stringFromPtr(param1);
         if(param2 != 0)
         {
      ...
      public function psize(param1:int) : int {
         ...
         _loc2_ = CSystemLocal.gworker.stringFromPtr(param1);
      ...
      public function access(param1:int, param2:int) : int {
         ...
         _loc3_ = CSystemLocal.gworker.stringFromPtr(param1);
         if(param2 & ~4)
         {
