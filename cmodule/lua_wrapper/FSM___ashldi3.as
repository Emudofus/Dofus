package cmodule.lua_wrapper
{
   public final class FSM___ashldi3 extends Machine
   {
      ...
      public static function start() : void {
         ...
         _loc1_ = op_li32(FSM___ashldi3.ebp + 16) /*Alchemy*/;
         _loc2_ = op_li32(FSM___ashldi3.ebp + 20) /*Alchemy*/;
         _loc3_ = op_li32(FSM___ashldi3.ebp + 8) /*Alchemy*/;
         _loc4_ = op_li32(FSM___ashldi3.ebp + 12) /*Alchemy*/;
         ...
         if(_loc5_ == 0)
         {
            ...
            FSM___ashldi3.ebp = op_li32(FSM___ashldi3.esp) /*Alchemy*/;
            FSM___ashldi3.esp = FSM___ashldi3.esp + 4;
            FSM___ashldi3.esp = FSM___ashldi3.esp + 4;
            return;
         }
