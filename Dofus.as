package 
{
   ...
   public class Dofus extends Sprite implements IFramerateListener, IApplicationContainer
   {
      ...
      private function onResize(e:NativeWindowDisplayStateEvent) : void {
         this._displayState=e.afterDisplayState;
      }
      ...
      private function initUi() : void {
         ...
         UiModuleManager.getInstance().sharedDefinitionContainer=sharedDefUri;
