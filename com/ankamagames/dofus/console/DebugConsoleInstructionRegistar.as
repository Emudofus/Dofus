package com.ankamagames.dofus.console
{
   ...
   public class DebugConsoleInstructionRegistar extends Object implements ConsoleInstructionRegistar
   {
      ...
      public function registerInstructions(console:ConsoleHandler) : void {
         ...
         console.addHandler(["uiinspector","inspectuielement","inspectuielementsos","modulelist","loadui","unloadui","clearuicache","setuiscale","useuicache","uilist","reloadui","fps","getmoduleinfo","chatoutput"],new UiHandlerInstructionHandler());
         ...
         console.addHandler(["savereplaylog","parallelsequenceteststart","log","i18nsize","newdofus","clear","config","clearwebcache","geteventmodeparams","setquality","lowdefskin","copylog","synchrosequence","throw","debugmouseover"],new MiscInstructionHandler());
         ...
         console.addHandler(["enablelogs","info","search","searchmonster","searchspell","enablereport","savereport"],new UtilInstructionHandler());
