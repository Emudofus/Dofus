package com.ankamagames.dofus.uiApi
{
   ...
   public class PlayedCharacterApi extends Object implements IApi
   {
      ...
      public static function getEntityInfos() : GameRolePlayCharacterInformations {
         ...
         var playerInfo:GameRolePlayCharacterInformations = entitiesFrame.getEntityInfos(PlayedCharacterManager.getInstance().infos.id) as GameRolePlayCharacterInformations;
         return playerInfo;
      }
