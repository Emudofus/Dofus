package com.ankamagames.dofus.externalnotification
{
    ...
    public class ExternalNotificationManager 
    {
        ...
        {
            var enWin:ExternalNotificationWindow;
            var foundNotification:ExternalNotificationWindow;
        ...
        {
            var foundNotifications:Vector.<ExternalNotificationWindow>;
            var enWin:ExternalNotificationWindow;
            if (this._notificationsList.length > 0)
            {
        ...
        {
            var extNotif:ExternalNotificationWindow;
        ...
        {
            var notificationX:Number;
            var notificationY:Number;
