package com.ankamagames.dofus.logic.game.roleplay.managers
{
    ...
    public final class AnimFunManager 
    {
        ...
        {
            var totalTimeNormalAnim:int;
            var totalTimeFastAnim:int;
            var af:AnimFun;
        ...
        private function synchCurrentAnim(pNextAnimFun:AnimFun, pElapsedTime:int):void
        {
            var i:int;
            var af:AnimFun;
            var previousAf:AnimFun;
            var entitySpr:TiphonSprite;
            var callback:Callback;
            var swlLoaded:Boolean;
...
class AnimFunInfo 
{
    ...
    public function AnimFunInfo(pAnimFun:AnimFun, pPreviousAnimFun:AnimFun, pElapsedTime:int, pLoadTime:int=0)
    {
...
class AnimFunClipInfo 
{
    ...
    public function AnimFunClipInfo(pDuration:int, pTotalFrames:int)
    {
