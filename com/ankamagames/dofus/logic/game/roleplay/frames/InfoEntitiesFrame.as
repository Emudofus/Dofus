package com.ankamagames.dofus.logic.game.roleplay.frames
{
   ...
   public class InfoEntitiesFrame extends Object implements Frame
   {
      ...
      public function pushed() : Boolean {
         ...
         if(!this._namesVisible)
         {
            ...
            else
            {
               ...
               ids=this._roleplayEntitiesFrame.playersId;
               for each (entityId in ids)
               {
                  ...
                  if(entityInfo!=null)
                  {
                     this.addEntity(entityId,entityInfo.name);
                  }
                  else
                  {
      ...
      private function gameRolePlayShowActorHandler(grpsamsg:Object) : void {
         ...
         else
         {
            ...
            if(de==null)
            {
               this.addEntity(entityId,infos.name);
            }
            else
            {
               de.visible=false;
      ...
      private function addEntity(entityId:int, pName:String) : void {
         var lbl:Label = null;
         ...
         if(this.getEntity(entityId)==null)
         {
            ...
            {
               de=new DisplayedEntity(entityId,lbl,this.getBounds(entityId));
      ...
      private function waitForEntity(pEvt:Event) : void {
         ...
         for each (entityId in this._waitList)
         {
            ...
            if((!(entity==null))&&(!(DofusEntities.getEntity(entityId)==null)))
            {
               ...
               if((!(entity.target.width==0))&&(!(entity.target.height==0)))
               {
   ...
   class DisplayedEntity extends Object
   {
      ...
      function DisplayedEntity(pId:int=0, pText:Label=null, pTarget:IRectangle=null) {
         super();
         this.entityId=pId;
         this.text=pText;
         this.target=pTarget;
