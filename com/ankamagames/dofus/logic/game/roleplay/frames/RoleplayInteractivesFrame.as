package com.ankamagames.dofus.logic.game.roleplay.frames
{
   ...
   public class RoleplayInteractivesFrame extends Object implements Frame
   {
      ...
      private function updateStatedElement(se:StatedElement) : void {
         ...
         if((se.elementState==COLLECTABLE_COLLECTING_STATE_ID)&&(this._ie[worldObject])&&(this._ie[worldObject].element.elementId==se.elementId))
         {
            ...
            if(interactive.actionId==COLLECTABLE_INTERACTIVE_ACTION_ID)
            {
         ...
         if(dataTab.length>0)
         {
            ...
            if(details!="")
            {
               ...
               if(needBtn)
               {
                  ...
                  NotificationManager.getInstance().addButtonToNotification(nid,I18n.getUiText("ui.npc.location"),"AddMapFlag",["flag_srv"+CompassTypeEnum.COMPASS_TYPE_SIMPLE+"_job",npcName+" ("+npcCoords.x+","+npcCoords.y+")",superAreaId,npcCoords.x,npcCoords.y,5605376,false,true],false,150,0,"hook");
               }
