package com.ankamagames.dofus.logic.game.fight.types
{
   ...
   public class BasicBuff extends Object
   {
      ...
      public function equals(other:BasicBuff, osefSpell:Boolean=false) : Boolean {
         ...
         if(((((!(this.targetId==other.targetId)||!(this.effects.effectId==other.actionId)||!(this.duration==other.duration)||this.effects.hasOwnProperty("delay")&&other.effects.hasOwnProperty("delay")&&!(this.effects.delay==other.effects.delay))||(((this.castingSpell.spellRank)&&(!osefSpell))&&(!(this.castingSpell.spellRank.id==other.castingSpell.spellRank.id))))||(!osefSpell&&!(this.castingSpell.spell.id==other.castingSpell.spell.id)))||(!(getQualifiedClassName(this)==getQualifiedClassName(other))))||(!(this.source==other.source))||(this.trigger))
         {
            return false;
         }
         ...
         else
         {
            ...
            else
            {
               ...
               if((thisActionId==other.actionId)&&((thisActionId==951)||(thisActionId==950)))
               {
