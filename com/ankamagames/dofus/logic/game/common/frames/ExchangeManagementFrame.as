      ...
      public function process(param1:Message) : Boolean
      {
         ...
         switch(true)
         {
            ...
            case param1 is StorageObjectsUpdateMessage:
               ...
               for each(_loc47_ in _loc14_.objectList)
               {
            ...
            case param1 is StorageObjectsRemoveMessage:
               ...
               for each(_loc49_ in _loc15_.objectUIDList)
               {
            ...
            case param1 is ExchangeObjectTransfertListToInvAction:
               ...
               if(_loc21_.ids.length >= ProtocolConstantsEnum.MIN_OBJ_COUNT_BY_XFERT)
               {
                  ...
                  _loc50_.initExchangeObjectTransfertListToInvMessage(_loc21_.ids.slice(0,ProtocolConstantsEnum.MAX_OBJ_COUNT_BY_XFERT));
            ...
            case param1 is ExchangeObjectTransfertListWithQuantityToInvAction:
               ...
               if(_loc22_.ids.length >= ProtocolConstantsEnum.MIN_OBJ_COUNT_BY_XFERT && _loc22_.ids.length == _loc22_.qtys.length)
               {
                  ...
                  _loc51_.initExchangeObjectTransfertListWithQuantityToInvMessage(_loc22_.ids.slice(0,ProtocolConstantsEnum.MAX_OBJ_COUNT_BY_XFERT / 2),_loc22_.qtys.slice(0,ProtocolConstantsEnum.MAX_OBJ_COUNT_BY_XFERT / 2));
            ...
            case param1 is ExchangeObjectTransfertListFromInvAction:
               ...
               if(_loc27_.ids.length >= ProtocolConstantsEnum.MIN_OBJ_COUNT_BY_XFERT)
               {
                  ...
                  _loc52_.initExchangeObjectTransfertListFromInvMessage(_loc27_.ids.slice(0,ProtocolConstantsEnum.MAX_OBJ_COUNT_BY_XFERT));
            ...
            case param1 is ExchangeStartOkNpcShopMessage:
               ...
               _loc33_ = new Array();
               for each(_loc53_ in _loc30_.objectsInfos)
               {
