package com.ankamagames.dofus.logic.game.common.frames
{
   ...
   public class InventoryManagementFrame extends Object implements Frame
   {
      ...
      public function process(msg:Message) : Boolean {
         ...
         var shorto:Shortcut = null;
         var shorts:Shortcut = null;
         ...
         switch(true)
         {
            ...
            case msg is ShortcutBarContentMessage:
               ...
               if(sbcmsg.barType==ShortcutBarEnum.GENERAL_SHORTCUT_BAR)
               {
                  ...
                  for each (shorto in sbcmsg.shortcuts)
                  {
               ...
               else
               {
                  if(sbcmsg.barType==ShortcutBarEnum.SPELL_SHORTCUT_BAR)
                  {
                     ...
                     for each (shorts in sbcmsg.shortcuts)
                     {
            ...
            case msg is ObjectUseAction:
               ...
               {
                  commonMod.openPopup(I18n.getUiText("ui.common.confirm"),I18n.getUiText("ui.common.confirmationUseItem",[iw.name]),[I18n.getUiText("ui.common.yes"),I18n.getUiText("ui.common.no")],[fncUseItem,null],fncUseItem,new function():void
                  {
               ...
               case msg is InventoryPresetUseResultMessage:
                  ...
                  else
                  {
                     ...
                     {
                        KernelEventsManager.getInstance().processCallback(ChatHookList.TextInformation,I18n.getUiText("ui.preset.inUse",[ipurmsg.presetId]),ChatActivableChannelsEnum.PSEUDO_CHANNEL_INFO,TimeManager.getInstance().getTimestamp());
                     }
                  }
                  return true;
                  break;
      ...
      private function getShortcutWrapperPropFromShortcut(shortcut:Object) : Object {
         var id:uint = 0;
         var type:uint = 0;
         var gid:uint = 0;
