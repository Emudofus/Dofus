package com.ankamagames.dofus.logic.game.common.frames
{
    ...
    public class ExternalGameFrame implements Frame 
    {
        ...
        public function process(msg:Message):Boolean
        {
            ...
            var _local_4:KrosmasterAuthTokenRequestMessage;
            var _local_5:KrosmasterAuthTokenErrorMessage;
            var _local_6:KrosmasterAuthTokenMessage;
            var _local_7:KrosmasterInventoryRequestAction;
            var _local_8:KrosmasterInventoryRequestMessage;
            var _local_9:KrosmasterInventoryErrorMessage;
            var _local_10:KrosmasterInventoryMessage;
            var _local_11:KrosmasterTransferRequestAction;
            var _local_12:KrosmasterTransferRequestMessage;
            var _local_13:KrosmasterTransferMessage;
            var _local_14:KrosmasterPlayingStatusAction;
            var _local_15:KrosmasterPlayingStatusMessage;
            var _local_16:ShopArticlesListRequestAction;
            var _local_17:ShopBuyRequestAction;
            var _local_18:ShopSearchRequestAction;
            var _local_19:GetComicRequestAction;
            var _local_20:GetComicsLibraryRequestAction;
            ...
            switch (true)
            {
                ...
                case (msg is KrosmasterTokenRequestAction):
                    ...
                    _local_4 = new KrosmasterAuthTokenRequestMessage();
                    _local_4.initKrosmasterAuthTokenRequestMessage();
                    ConnectionsHandler.getConnection().send(_local_4);
                    return (true);
                case (msg is KrosmasterAuthTokenErrorMessage):
                    _local_5 = (msg as KrosmasterAuthTokenErrorMessage);
                    ...
                    {
                        KernelEventsManager.getInstance().processCallback(ExternalGameHookList.KrosmasterAuthTokenError, _local_5.reason);
                    };
                    return (true);
                case (msg is KrosmasterAuthTokenMessage):
                    _local_6 = (msg as KrosmasterAuthTokenMessage);
                    if (this._openingShop)
                    {
                        this._dofusShopManager = DofusShopManager.getInstance();
                        this._dofusShopManager.init(_local_6.token);
                        this._openingShop = false;
                    }
                    else
                    {
                        KernelEventsManager.getInstance().processCallback(ExternalGameHookList.KrosmasterAuthToken, _local_6.token);
                    };
                    return (true);
                case (msg is KrosmasterInventoryRequestAction):
                    _local_7 = (msg as KrosmasterInventoryRequestAction);
                    _local_8 = new KrosmasterInventoryRequestMessage();
                    _local_8.initKrosmasterInventoryRequestMessage();
                    ConnectionsHandler.getConnection().send(_local_8);
                    return (true);
                case (msg is KrosmasterInventoryErrorMessage):
                    _local_9 = (msg as KrosmasterInventoryErrorMessage);
                    KernelEventsManager.getInstance().processCallback(ExternalGameHookList.KrosmasterInventoryError, _local_9.reason);
                    return (true);
                case (msg is KrosmasterInventoryMessage):
                    _local_10 = (msg as KrosmasterInventoryMessage);
                    KernelEventsManager.getInstance().processCallback(ExternalGameHookList.KrosmasterInventory, _local_10.figures);
                    return (true);
                case (msg is KrosmasterTransferRequestAction):
                    _local_11 = (msg as KrosmasterTransferRequestAction);
                    _local_12 = new KrosmasterTransferRequestMessage();
                    _local_12.initKrosmasterTransferRequestMessage(_local_11.figureId);
                    ConnectionsHandler.getConnection().send(_local_12);
                    return (true);
                case (msg is KrosmasterTransferMessage):
                    _local_13 = (msg as KrosmasterTransferMessage);
                    KernelEventsManager.getInstance().processCallback(ExternalGameHookList.KrosmasterTransfer, _local_13.uid, _local_13.failure);
                    return (true);
                case (msg is KrosmasterPlayingStatusAction):
                    _local_14 = (msg as KrosmasterPlayingStatusAction);
                    _local_15 = new KrosmasterPlayingStatusMessage();
                    _local_15.initKrosmasterPlayingStatusMessage(_local_14.playing);
                ...
                case (msg is ShopArticlesListRequestAction):
                    _local_16 = (msg as ShopArticlesListRequestAction);
                    this._dofusShopManager.getArticlesList(_local_16.categoryId, _local_16.pageId);
                    return (true);
                case (msg is ShopBuyRequestAction):
                    _local_17 = (msg as ShopBuyRequestAction);
                    this._dofusShopManager.buyArticle(_local_17.articleId, _local_17.quantity);
                    return (true);
                case (msg is ShopFrontPageRequestAction):
                    this._dofusShopManager.getHome();
                    return (true);
                case (msg is ShopSearchRequestAction):
                    _local_18 = (msg as ShopSearchRequestAction);
                    this._dofusShopManager.searchForArticles(_local_18.text, _local_18.pageId);
                    return (true);
                case (msg is GetComicRequestAction):
                    _local_19 = (msg as GetComicRequestAction);
                    ComicsManager.getInstance().getComic(_local_19.remoteId, _local_19.language, _local_19.previewOnly);
                    return (true);
                case (msg is GetComicsLibraryRequestAction):
                    _local_20 = (msg as GetComicsLibraryRequestAction);
                    ComicsManager.getInstance().getLibrary(_local_20.accountId);
                    return (true);
            };
            return (false);
        }
