      ...
      public function process(msg:Message) : Boolean {
         ...
         switch(true)
         {
            ...
            case msg is ExchangeShopStockModifyObjectAction:
               ...
               eomfpmsg.initExchangeObjectModifyPricedMessage(essmoa.objectUID,essmoa.quantity,essmoa.price);
            ...
            case msg is ExchangeShopStockMultiMovementUpdatedMessage:
               ...
               loop1:
               for(;essmmumsg.objectInfoList hasNext _loc26_;if(newItem2)
               {
                  this._shopStock.push(
                     {
                        itemWrapper:itemWrapper,
                  ...
                  {
                     objectInfo=nextValue(_loc26_,_loc27_);
