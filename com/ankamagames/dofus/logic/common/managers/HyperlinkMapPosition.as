package com.ankamagames.dofus.logic.common.managers
{
    ...
    public class HyperlinkMapPosition 
    {
        ...
        {
            KernelEventsManager.getInstance().processCallback(HookList.AddMapFlag, "flag_chat", (((((I18n.getUiText("ui.cartography.chatFlag") + " (") + posX) + ",") + posY) + ")"), worldMapId, posX, posY, 0xFF6600, true);
        }
