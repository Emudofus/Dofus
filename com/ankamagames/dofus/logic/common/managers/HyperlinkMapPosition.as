package com.ankamagames.dofus.logic.common.managers
{
   ...
   public class HyperlinkMapPosition extends Object
   {
      ...
      public static function showPosition(posX:int, posY:int) : void {
         var superAreaId:int = PlayedCharacterManager.getInstance().currentSubArea.area.superAreaId;
         KernelEventsManager.getInstance().processCallback(HookList.AddMapFlag,"flag_chat",I18n.getUiText("ui.cartography.chatFlag")+" ("+posX+","+posY+")",superAreaId,posX,posY,16737792,true);
      }
