package com.ankamagames.dofus.datacenter.items.criterion
{
   ...
   public class ItemCriterion extends Object implements IItemCriterion, IDataCenter
   {
      ...
      public function get text() : String {
         ...
         {
            case "CM":
               readableCriterionRef=I18n.getUiText("ui.stats.MP");
               break;
            case "CP":
               readableCriterionRef=I18n.getUiText("ui.stats.AP");
               break;
            case "CH":
      ...
      protected function getCriterion() : int {
         ...
         switch(this._criterionRef)
         {
            ...
            case "CE":
               ...
               break;
            case "CD":
               criterion=player.characteristics.alignmentInfos.dishonor;
               break;
            case "CH":
