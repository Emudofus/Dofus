package com.ankamagames.dofus.scripts.spells
{
    ...
    public class SpellScript6 extends SpellScriptBase 
    {
        ...
        public function SpellScript6(spellFxRunner:SpellFxRunner)
        {
            ...
            var orientationStep:ISequencable;
            var casterGfxAngle:int;
            var spellGfxCasterYOffset:int;
            var spellGfxCasterShowUnder:Boolean;
            var gfxCasterStep:ISequencable;
            var targetGfxAngle:int;
            var spellGfxTargetYOffset:int;
            var spellGfxTargetShowUnder:Boolean;
            var gfxTargetStep:ISequencable;
            var missileGfx:Projectile;
            var levelChange:Boolean;
            var subExplo:Boolean;
            ...
            if (SpellFxApi.HasSpellParam(spell, "targetGfxId"))
            {
                ...
                {
                    if (((SpellFxApi.HasSpellParam(spell, "playTargetGfxFirst")) && (SpellFxApi.GetSpellParam(spell, "playTargetGfxFirst"))))
                    {
            ...
            if (SpellFxApi.HasSpellParam(spell, "animId"))
            {
                ...
                {
                    if (((SpellFxApi.HasSpellParam(spell, "playTargetGfxFirst2")) && (SpellFxApi.GetSpellParam(spell, "playTargetGfxFirst2"))))
                    {
                        SpellFxApi.AddStepBefore(runner, latestStep, gfxTargetStep);
                    }
                    else
