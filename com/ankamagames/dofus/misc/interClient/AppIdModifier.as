      ...
      public function AppIdModifier() {
         ...
         do
         {
            ...
            if(!idFile.exists)
            {
               ...
               soFolder=File.applicationStorageDirectory.resolvePath("#SharedObjects/"+FileUtils.getFileName(Dofus.getInstance().loaderInfo.loaderURL));
               appInfoFile=new File(COMMON_FOLDER+APP_INFO);
               try
               {
         ...
         while(currentTimestamp-ts<=30000);
      }
