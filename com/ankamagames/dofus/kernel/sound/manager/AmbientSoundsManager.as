      ...
      public function playMusicAndAmbient() : void {
         ...
         else
         {
            ...
            else
            {
               ...
               {
                  fadeOut=new VolumeFadeEffect(-1,0,TubulSoundConfiguration.TIME_FADE_OUT_MUSIC);
               ...
               fade=new VolumeFadeEffect(-1,1,TubulSoundConfiguration.TIME_FADE_IN_MUSIC);
