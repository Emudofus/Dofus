package com.ankamagames.dofus.kernel.sound.manager
{
    ...
    public class ClassicSoundManager extends EventDispatcher implements ISoundManager 
    {
        ...
        {
            var busMusic1:IAudioBus;
            var busAmbiance1:IAudioBus;
            var busMusic2:IAudioBus;
            var busAmbiance2:IAudioBus;
        ...
        public function setSoundSourcePosition(pEntityId:int, pPosition:Point):void
        {
            ...
            {
                _local_3 = this.entitySounds[pEntityId];
                for each (_local_4 in _local_3)
                {
                    if ((_local_4 is LocalizedSound))
                    {
                        (_local_4 as LocalizedSound).position = pPosition;
                    };
                };
            };
        }
        ...
        {
            var fadeOne:VolumeFadeEffect;
            var fadeTwo:VolumeFadeEffect;
            if (!(this.checkIfAvailable()))
            {
                return;
            };
        ...
        public function stopIntroMusic(pImmediatly:Boolean=false):void
        {
            ...
            if (this._introHarmonicOne)
            {
                ...
                {
                    _local_2 = new VolumeFadeEffect(-1, 0, TubulSoundConfiguration.TIME_FADE_OUT_INTRO);
                    this._introHarmonicOne.stop(_local_2);
                };
            ...
            if (this._introHarmonicTwo)
            {
                ...
                {
                    _local_3 = new VolumeFadeEffect(-1, 0, TubulSoundConfiguration.TIME_FADE_OUT_INTRO);
                    this._introHarmonicTwo.stop(_local_3);
                };
