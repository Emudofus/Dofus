package com.ankamagames.dofus.network.types.game.context.roleplay.party
{
   ...
   public class PartyMemberArenaInformations extends PartyMemberInformations implements INetworkType
   {
      ...
      public function initPartyMemberArenaInformations(id:uint=0, level:uint=0, name:String="", entityLook:EntityLook=null, breed:int=0, sex:Boolean=false, lifePoints:uint=0, maxLifePoints:uint=0, prospecting:uint=0, regenRate:uint=0, initiative:uint=0, pvpEnabled:Boolean=false, alignmentSide:int=0, worldX:int=0, worldY:int=0, mapId:int=0, subAreaId:uint=0, status:PlayerStatus=null, rank:uint=0) : PartyMemberArenaInformations {
         super.initPartyMemberInformations(id,level,name,entityLook,breed,sex,lifePoints,maxLifePoints,prospecting,regenRate,initiative,pvpEnabled,alignmentSide,worldX,worldY,mapId,subAreaId,status);
         this.rank=rank;
         return this;
      }
