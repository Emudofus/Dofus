package com.ankamagames.dofus.network.types.game.context.fight
{
   ...
   public class GameFightFighterLightInformations extends Object implements INetworkType
   {
      ...
      public function initGameFightFighterLightInformations(id:int=0, name:String="", level:uint=0, breed:int=0, sex:Boolean=false, alive:Boolean=false) : GameFightFighterLightInformations {
         this.id=id;
         this.name=name;
         this.level=level;
         this.breed=breed;
