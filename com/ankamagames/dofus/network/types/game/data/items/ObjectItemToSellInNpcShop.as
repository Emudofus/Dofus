package com.ankamagames.dofus.network.types.game.data.items
{
   ...
   public class ObjectItemToSellInNpcShop extends ObjectItemMinimalInformation implements INetworkType
   {
      ...
      public function initObjectItemToSellInNpcShop(objectGID:uint=0, powerRate:int=0, overMax:Boolean=false, effects:Vector.<ObjectEffect>=null, objectPrice:uint=0, buyCriterion:String="") : ObjectItemToSellInNpcShop {
         super.initObjectItemMinimalInformation(objectGID,powerRate,overMax,effects);
