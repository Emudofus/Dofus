package com.ankamagames.dofus.network.types.game.character.characteristic
{
   ...
   public class CharacterCharacteristicsInformations extends Object implements INetworkType
   {
                                 ...
                                 else
                                 {
                                    ...
                                    else
                                    {
                                       ...
                                       else
                                       {
                                          ...
                                          _i72=0;
                                          while(_i72<this.spellModifications.length)
                                          {
                                             (this.spellModifications[_i72] as CharacterSpellModification).serializeAs_CharacterSpellModification(output);
                                             _i72++;
                                          }
                                          return;
                                       }
      ...
      public function deserializeAs_CharacterCharacteristicsInformations(input:IDataInput) : void {
         var _item72:CharacterSpellModification = null;
                                 ...
                                 else
                                 {
                                    ...
                                    else
                                    {
                                       ...
                                       else
                                       {
                                          ...
                                          _i72=0;
                                          while(_i72<_spellModificationsLen)
                                          {
                                             _item72=new CharacterSpellModification();
                                             _item72.deserialize(input);
                                             this.spellModifications.push(_item72);
                                             _i72++;
                                          }
                                          return;
                                       }
