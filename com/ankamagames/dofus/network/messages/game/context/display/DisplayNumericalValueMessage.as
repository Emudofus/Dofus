package com.ankamagames.dofus.network.messages.game.context.display
{
    ...
    public class DisplayNumericalValueMessage extends NetworkMessage implements INetworkMessage 
    {
        ...
        public function serializeAs_DisplayNumericalValueMessage(output:ICustomDataOutput):void
        {
        ...
        public function deserializeAs_DisplayNumericalValueMessage(input:ICustomDataInput):void
        {
