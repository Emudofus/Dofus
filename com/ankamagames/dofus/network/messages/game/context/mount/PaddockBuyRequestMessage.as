package com.ankamagames.dofus.network.messages.game.context.mount
{
    ...
    public class PaddockBuyRequestMessage extends NetworkMessage implements INetworkMessage
    {
        ...
        public function serializeAs_PaddockBuyRequestMessage(param1:IDataOutput) : void
        {
            return;
        }// end function
        ...
        public function deserializeAs_PaddockBuyRequestMessage(param1:IDataInput) : void
        {
            return;
        }// end function
