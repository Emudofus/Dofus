package com.ankamagames.dofus.network.messages.game.context.roleplay.job
{
   ...
   public class JobAllowMultiCraftRequestSetMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_JobAllowMultiCraftRequestSetMessage(param1:ICustomDataOutput) : void
      {
      ...
      public function deserializeAs_JobAllowMultiCraftRequestSetMessage(param1:ICustomDataInput) : void
      {
