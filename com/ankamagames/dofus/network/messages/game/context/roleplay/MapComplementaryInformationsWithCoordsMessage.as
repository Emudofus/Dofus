package com.ankamagames.dofus.network.messages.game.context.roleplay
{
   ...
   public class MapComplementaryInformationsWithCoordsMessage extends MapComplementaryInformationsDataMessage implements INetworkMessage
   {
      ...
      public function initMapComplementaryInformationsWithCoordsMessage(subAreaId:uint=0, mapId:uint=0, subareaAlignmentSide:int=0, houses:Vector.<HouseInformations>=null, actors:Vector.<GameRolePlayActorInformations>=null, interactiveElements:Vector.<InteractiveElement>=null, statedElements:Vector.<StatedElement>=null, obstacles:Vector.<MapObstacle>=null, fights:Vector.<FightCommonInformations>=null, worldX:int=0, worldY:int=0) : MapComplementaryInformationsWithCoordsMessage {
