package com.ankamagames.dofus.network.messages.game.context.roleplay.npc
{
   ...
   public class AlliancePrismDialogQuestionMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_AlliancePrismDialogQuestionMessage(param1:IDataOutput) : void {
      }
      
      public function deserialize(param1:IDataInput) : void {
      }
      
      public function deserializeAs_AlliancePrismDialogQuestionMessage(param1:IDataInput) : void {
      }
   }
}
