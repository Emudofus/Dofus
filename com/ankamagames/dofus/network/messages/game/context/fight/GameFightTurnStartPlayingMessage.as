package com.ankamagames.dofus.network.messages.game.context.fight
{
   ...
   public class GameFightTurnStartPlayingMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_GameFightTurnStartPlayingMessage(param1:IDataOutput) : void {
      }
      
      public function deserialize(param1:IDataInput) : void {
      }
      
      public function deserializeAs_GameFightTurnStartPlayingMessage(param1:IDataInput) : void {
      }
   }
}
