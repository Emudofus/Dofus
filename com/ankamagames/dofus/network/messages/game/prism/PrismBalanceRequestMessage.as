package com.ankamagames.dofus.network.messages.game.prism
{
    ...
    public class PrismBalanceRequestMessage extends NetworkMessage implements INetworkMessage
    {
        ...
        public function serializeAs_PrismBalanceRequestMessage(param1:IDataOutput) : void
        {
            return;
        }// end function
        ...
        public function deserializeAs_PrismBalanceRequestMessage(param1:IDataInput) : void
        {
            return;
        }// end function
