package com.ankamagames.dofus.network.messages.game.basic
{
    ...
    public class BasicLatencyStatsRequestMessage extends NetworkMessage implements INetworkMessage
    {
        ...
        public function serializeAs_BasicLatencyStatsRequestMessage(param1:IDataOutput) : void
        {
            return;
        }// end function
        ...
        public function deserializeAs_BasicLatencyStatsRequestMessage(param1:IDataInput) : void
        {
            return;
        }// end function
