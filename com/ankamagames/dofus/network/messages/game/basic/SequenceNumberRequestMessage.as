package com.ankamagames.dofus.network.messages.game.basic
{
    ...
    public class SequenceNumberRequestMessage extends NetworkMessage implements INetworkMessage
    {
        ...
        public function serializeAs_SequenceNumberRequestMessage(param1:IDataOutput) : void
        {
            return;
        }// end function
        ...
        public function deserializeAs_SequenceNumberRequestMessage(param1:IDataInput) : void
        {
            return;
        }// end function
