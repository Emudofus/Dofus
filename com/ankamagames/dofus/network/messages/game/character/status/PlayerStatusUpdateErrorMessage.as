package com.ankamagames.dofus.network.messages.game.character.status
{
   ...
   public class PlayerStatusUpdateErrorMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_PlayerStatusUpdateErrorMessage(param1:IDataOutput) : void {
      }
      
      public function deserialize(param1:IDataInput) : void {
      }
      
      public function deserializeAs_PlayerStatusUpdateErrorMessage(param1:IDataInput) : void {
      }
   }
}
