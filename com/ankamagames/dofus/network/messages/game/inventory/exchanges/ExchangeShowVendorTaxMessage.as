package com.ankamagames.dofus.network.messages.game.inventory.exchanges
{
   ...
   public class ExchangeShowVendorTaxMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_ExchangeShowVendorTaxMessage(output:IDataOutput) : void {
      }
      
      public function deserialize(input:IDataInput) : void {
      }
      
      public function deserializeAs_ExchangeShowVendorTaxMessage(input:IDataInput) : void {
      }
   }
}
