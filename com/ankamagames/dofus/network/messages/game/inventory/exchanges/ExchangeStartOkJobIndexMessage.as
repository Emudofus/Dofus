package com.ankamagames.dofus.network.messages.game.inventory.exchanges
{
    ...
    public class ExchangeStartOkJobIndexMessage extends NetworkMessage implements INetworkMessage
    {
        ...
        public function serializeAs_ExchangeStartOkJobIndexMessage(param1:IDataOutput) : void
        {
            ...
            var _loc_2:* = 0;
            while (_loc_2 < this.jobs.length)
            {
                
                if (this.jobs[_loc_2] < 0)
                {
                    throw new Error("Forbidden value (" + this.jobs[_loc_2] + ") on element 1 (starting at 1) of jobs.");
                }
                param1.writeInt(this.jobs[_loc_2]);
                _loc_2 = _loc_2 + 1;
            }
            return;
        }// end function
        ...
        public function deserializeAs_ExchangeStartOkJobIndexMessage(param1:IDataInput) : void
        {
            ...
            while (_loc_3 < _loc_2)
            {
                ...
                if (_loc_4 < 0)
                {
                    throw new Error("Forbidden value (" + _loc_4 + ") on elements of jobs.");
                }
                this.jobs.push(_loc_4);
                _loc_3 = _loc_3 + 1;
            }
            return;
        }// end function
