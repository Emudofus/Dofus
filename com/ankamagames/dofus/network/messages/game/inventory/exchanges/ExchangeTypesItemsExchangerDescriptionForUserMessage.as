package com.ankamagames.dofus.network.messages.game.inventory.exchanges
{
    ...
    public class ExchangeTypesItemsExchangerDescriptionForUserMessage extends NetworkMessage implements INetworkMessage
    {
        ...
        public function serializeAs_ExchangeTypesItemsExchangerDescriptionForUserMessage(param1:IDataOutput) : void
        {
            ...
            var _loc_2:uint = 0;
            while (_loc_2 < this.itemTypeDescriptions.length)
            {
                
                (this.itemTypeDescriptions[_loc_2] as BidExchangerObjectInfo).serializeAs_BidExchangerObjectInfo(param1);
                _loc_2 = _loc_2 + 1;
            }
            return;
        }// end function
        ...
        {
            var _loc_4:BidExchangerObjectInfo = null;
            var _loc_2:* = param1.readUnsignedShort();
            var _loc_3:uint = 0;
            while (_loc_3 < _loc_2)
            {
                
                _loc_4 = new BidExchangerObjectInfo();
                _loc_4.deserialize(param1);
                this.itemTypeDescriptions.push(_loc_4);
                _loc_3 = _loc_3 + 1;
            }
            return;
        }// end function
