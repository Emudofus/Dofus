package com.ankamagames.dofus.network.messages.game.approach
{
   ...
   public class AccountCapabilitiesMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function initAccountCapabilitiesMessage(accountId:int=0, tutorialAvailable:Boolean=false, breedsVisible:uint=0, breedsAvailable:uint=0, status:int=0) : AccountCapabilitiesMessage {
