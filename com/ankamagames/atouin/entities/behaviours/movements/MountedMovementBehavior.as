package com.ankamagames.atouin.entities.behaviours.movements
{
    ...
    public class MountedMovementBehavior extends AnimatedMovementBehavior 
    {
        ...
        private static const RUN_LINEAR_VELOCITY:Number = (1 / 135);//0.00740740740740741
        private static const RUN_HORIZONTAL_DIAGONAL_VELOCITY:Number = (1 / 200);//0.005
        private static const RUN_VERTICAL_DIAGONAL_VELOCITY:Number = (1 / 120);//0.00833333333333333
