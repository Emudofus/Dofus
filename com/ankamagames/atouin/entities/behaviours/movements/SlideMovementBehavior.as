package com.ankamagames.atouin.entities.behaviours.movements
{
    ...
    public class SlideMovementBehavior extends AnimatedMovementBehavior 
    {
        ...
        private static const RUN_LINEAR_VELOCITY:Number = ((1 / 170) * 3);//0.0176470588235294
        private static const RUN_HORIZONTAL_DIAGONAL_VELOCITY:Number = ((1 / 0xFF) * 3);//0.0117647058823529
        private static const RUN_VERTICAL_DIAGONAL_VELOCITY:Number = ((1 / 150) * 3);//0.02
