package com.ankamagames.atouin.entities.behaviours.movements
{
    ...
    public class ParableMovementBehavior extends AnimatedMovementBehavior 
    {
        ...
        private static const LINEAR_VELOCITY:Number = (1 / 400);//0.0025
        private static const HORIZONTAL_DIAGONAL_VELOCITY:Number = (1 / 500);//0.002
        private static const VERTICAL_DIAGONAL_VELOCITY:Number = (1 / 450);//0.00222222222222222
