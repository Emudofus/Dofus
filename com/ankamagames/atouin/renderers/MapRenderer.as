package com.ankamagames.atouin.renderers
{
   ...
   public class MapRenderer extends EventDispatcher
   {
      ...
      public function render(dataContainer:DataMapContainer, forceReloadWithoutCache:Boolean=false, renderId:uint=0) : void {
         var uri:Uri = null;
         var isJpg:* = false;
      ...
      private function renderFixture(fixtures:Array, container:Bitmap) : void {
         ...
         for each (fixture in fixtures)
         {
            ...
            {
               this._clTrans.redMultiplier=fixture.redMultiplier/128+1;
               this._clTrans.greenMultiplier=fixture.greenMultiplier/128+1;
               this._clTrans.blueMultiplier=fixture.blueMultiplier/128+1;
