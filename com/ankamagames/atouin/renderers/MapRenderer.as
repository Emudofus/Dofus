package com.ankamagames.atouin.renderers
{
    ...
    public class MapRenderer extends EventDispatcher 
    {
        ...
        public function MapRenderer(container:DisplayObjectContainer, elements:Elements)
        {
            ...
            downloadProgressBarBorder.graphics.lineStyle(1, 0x888888);
            downloadProgressBarBorder.graphics.beginFill(0x222222);
            ...
            this._downloadProgressBar.graphics.beginFill(0x99C500);
        ...
        public function render(dataContainer:DataMapContainer, forceReloadWithoutCache:Boolean=false, renderId:uint=0, renderFixture:Boolean=true):void
        {
            var uri:Uri;
            var isJpg:Boolean;
            var nged:NormalGraphicalElementData;
        ...
        public function isCellUnderFixture(pCellId:uint):Boolean
        {
            ...
            return (this._bitmapForegroundContainer.bitmapData.hitTest(new Point(this._bitmapForegroundContainer.x, this._bitmapForegroundContainer.y), 0xFF, new Rectangle(cellRef.x, cellRef.y, AtouinConstants.CELL_WIDTH, AtouinConstants.CELL_HEIGHT)));
        }
        ...
        {
            var mapDisplayManager:MapDisplayManager;
        ...
        private function addCellBitmapsElements(cell:Cell, cellCtr:ICellContainer, transparent:Boolean=false, ground:Boolean=false):Boolean
        {
            ...
            var elemenForDebug:DisplayObject;
            var ie:Object;
            ...
            for (;i < nbElements;(i = (i + 1)))
            {
                ...
                switch (element.elementType)
                {
                    case ElementTypesEnum.GRAPHICAL:
                        ...
                        {
                            colors = {
                                "red":(ge.colorMultiplicator.red / 0xFF),
                                "green":(ge.colorMultiplicator.green / 0xFF),
                                "blue":(ge.colorMultiplicator.blue / 0xFF),
                                "alpha":data.alpha
                            };
                        };
                        if (transparent)
                ...
                else
                {
                    if (element.elementType != ElementTypesEnum.SOUND)
                    {
                        ...
                        {
                            this._ceilBitmapData = new BitmapData(AtouinConstants.CELL_WIDTH, AtouinConstants.CELL_HEIGHT, false, 0xCC00CC);
                            shape = new Shape();
                            shape.graphics.beginFill(0xCC00CC);
            ...
            for each (fixture in fixtures)
            {
                ...
                else
                {
                    ...
                    if (((((((fixture.redMultiplier) || (fixture.greenMultiplier))) || (fixture.blueMultiplier))) || (!((fixture.alpha == 1)))))
                    {
                        ...
                        this._clTrans.alphaMultiplier = (fixture.alpha / 0xFF);
