package com.ankamagames.atouin
{
    ...
    public class AtouinConstants 
    {
        ...
        public static const PATHFINDER_MAX_Y:int = (13 + 1);//14
        public static const VIEW_DETECT_CELL_WIDTH:int = (2 * CELL_WIDTH);//172
        public static const MIN_MAP_X:int = -255;
        public static const MAX_MAP_X:int = 0xFF;
        public static const MIN_MAP_Y:int = -255;
        public static const MAX_MAP_Y:int = 0xFF;
