package com.ankamagames.berilia.components.params
{
   ...
   public class TooltipProperties extends UiProperties
   {
      ...
      public function TooltipProperties(tooltip:Tooltip, autoHide:Boolean, position:IRectangle, point:uint, relativePoint:uint, offset:int, data:*, makerParam:Object, zoom:Number=1) {
         super();
