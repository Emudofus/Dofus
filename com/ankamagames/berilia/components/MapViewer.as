   ...
   public class MapViewer extends GraphicContainer implements FinalizableUIComponent
   {
      ...
      public function setupZoomLevels(param1:Number, param2:Number) : void
      {
         ...
         if(_loc4_)
         {
            ...
            {
               this._zoomLevels.splice(this._zoomLevels.indexOf(_loc3_),1);
            }
      ...
      public function addIcon(param1:String, param2:String, param3:*, param4:int, param5:int, param6:Number = 1, param7:String = null, param8:Boolean = false, param9:int = -1, param10:Boolean = true, param11:Boolean = true) : MapIconElement
      {
         ...
         var _loc16_:* = 0;
         var _loc17_:* = 0;
         var _loc18_:ColorTransform = null;
         if((this._layers[param1]) && (this.mapBounds.contains(param4,param5)))
         {
            ...
            {
               _loc13_ = 0.75 + 1 / this._mapContainer.scaleX;
            }
            else
            {
            ...
            if(param9 != -1)
            {
               _loc15_ = param9 >> 16 & 255;
               _loc16_ = param9 >> 8 & 255;
               _loc17_ = param9 >> 0 & 255;
               _loc18_ = new ColorTransform(0.6,0.6,0.6,1,_loc15_ - 80,_loc16_ - 80,_loc17_ - 80);
               _loc12_.transform.colorTransform = _loc18_;
            }
      ...
      {
         if(this._zoomLevelsPercent.indexOf(param1) != -1)
         {
            this.zoom(param1 / 100,param2);
         }
         else
         {
            _log.warn("Can\'t zoom, a scale of " + String(param1 / 100) + " (" + param1 + ") is not defined");
         }
      }
      ...
      private function updateVisibleChunck(param1:Boolean = true) : void
      {
         ...
         for each(_loc3_ in this._currentMap.areas)
         {
            if(this._viewRect.intersects(_loc3_))
            {
               ...
               this._visibleMapAreas.push(_loc3_);
            }
            else if(_loc3_.isUsed)
            {
               _loc3_.free();
            }
