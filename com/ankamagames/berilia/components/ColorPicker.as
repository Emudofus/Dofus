package com.ankamagames.berilia.components
{
    ...
    public class ColorPicker extends GraphicContainer implements FinalizableUIComponent 
    {
        ...
        private var _nColor:uint = 0xFF0000;
        private var _nGradientColor:uint = 0xFF0000;
        ...
        public function finalize():void
        {
            ...
            this._aColorsHue = new Array(0xFF0000, 0xFFFF00, 0xFF00, 0xFFFF, 0xFF, 0xFF00FF, 0xFF0000);
            this._aAlphasHue = new Array(100, 100, 100, 100, 100, 100, 100);
            this._aRatiosHue = new Array(0, ((1 * 0xFF) / 6), ((2 * 0xFF) / 6), ((3 * 0xFF) / 6), ((4 * 0xFF) / 6), ((5 * 0xFF) / 6), 0xFF);
            ...
            this._aColorsSat = new Array(0x808080, 0x808080);
            this._aAlphasSat = new Array(0, 100);
            this._aRatiosSat = new Array(0, 0xFF);
            ...
            this._aRatiosBri = new Array(0, 127.5, 127.5, 0xFF);
            this._aColorsBri = new Array(0xFFFFFF, 0xFFFFFF, 0, 0);
        ...
        public function getGradientColor():uint
        {
            ...
            colorPoint2 = (0xFF - (((this._aRatiosHue[(i + 1)] - colorPoint1) / (this._aRatiosHue[(i + 1)] - this._aRatiosHue[i])) * 0xFF));
            ...
            colorPoint1 = ((this._nGradientY / this._nHeight) * 0xFF);
        ...
        private function getCurrentColor():uint
        {
            ...
            if (!(this._bFixedColor))
            {
                ...
                r1 = ((this._nGradientColor & 0xFF0000) >> 16);
                g1 = ((this._nGradientColor & 0xFF00) >> 8);
                b1 = (this._nGradientColor & 0xFF);
                if (colorPoint >= 0)
                {
