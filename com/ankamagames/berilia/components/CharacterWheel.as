package com.ankamagames.berilia.components
{
    ...
    public class CharacterWheel extends GraphicContainer implements FinalizableUIComponent 
    {
        ...
        {
            var g:GraphicContainer;
            var num:int;
            var i:int;
            var behavior:ISubEntityBehavior;
            var tiphonEntity:TiphonEntity;
            var numChildrenCtr:uint;
            if (!(__removed))
            {
        ...
        public function equipCharacter(list:Array, numDelete:int=0):void
        {
            ...
            {
                _local_6 = base[1].split(",");
                _local_7 = 0;
                while (_local_7 < numDelete)
                {
                    _local_6.pop();
                    _local_7++;
                };
                base[1] = _local_6.join(",");
            };
        ...
        private function charactersDisplay():void
        {
            ...
            var characterInfo:CBI;
            var oPerso:TiphonEntity;
            var cat:*;
            ...
            {
                _local_7 = ((2 * Math.PI) / this._nNbCharacters);
                this._nRotation = 0;
                this._nRotationPieceTrg = 0;
                this._aRenderePartNames = new Array();
                _local_8 = 0;
                while (_local_8 < this._nNbCharacters)
                {
                    if (this._aCharactersList[_local_8])
                    {
                        angle = ((_local_7 * _local_8) % (2 * Math.PI));
                        ...
                        characterInfo = new CBI(this._aCharactersList[_local_8].id, this._aCharactersList[_local_8].breedId, new Array());
                        this._aEntitiesLook[_local_8].look = SecureCenter.unsecure(this._aEntitiesLook[_local_8].look);
                        oPerso = new TiphonEntity(this._aEntitiesLook[_local_8].id, this._aEntitiesLook[_local_8].look);
                        ctr.addChild(oPerso);
                        oPerso.name = ("char" + _local_8);
                        ...
                        this._aSprites[_local_8] = oPerso;
                        ...
                        if (this._aEntitiesLook[_local_8].disabled)
                        {
                        ...
                        this._aMountainsCtr[_local_8] = ctr;
                    };
                    _local_8++;
                };
        ...
        private function rotateMountains(sens:int):void
        {
            ...
            var _local_4:IInterfaceListener;
            ...
            {
                for each (_local_4 in Berilia.getInstance().UISoundListeners)
                {
                    _local_4.playUISound("16080");
                };
            };
...
class TiphonEntity extends TiphonSprite implements IEntity 
{
    ...
    public function TiphonEntity(id:uint, look:TiphonEntityLook)
    {
        super(look);
        this._id = id;
        mouseEnabled = false;
...
class CBI 
{
    ...
    public function CBI(id:uint, breed:int, colors:Array)
    {
