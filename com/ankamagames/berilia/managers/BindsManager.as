package com.ankamagames.berilia.managers
{
    ...
    public class BindsManager extends GenericEventsManager 
    {
        ...
        public function processCallback(o:*, ... args):void
        {
            ...
            var aGe:Array;
            var currentFocus:TextField;
            var inputUi:UiRootContainer;
            var modalUi:Boolean;
            var i:uint;
        ...
        private function fillShortcutsEnum():void
        {
            ...
            for (i in ShortcutsEnum.BASIC_SHORTCUT_KEYCODE)
            {
                ShortcutsEnum.BASIC_SHORTCUT_NAME[ShortcutsEnum.BASIC_SHORTCUT_KEYCODE] = i;
            };
        }
        ...
        private function parseBindsXml(sXml:String, removeOldbinds:Boolean):void
        {
            ...
            var bind:Bind;
            var init:Boolean;
            var registeredKeys:Array;
            var elementsToRemove:Vector.<uint>;
            var xBind:XML;
            var o:Object;
            var i:uint;
            var nbElementsToRemove:int;
