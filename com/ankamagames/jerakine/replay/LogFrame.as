    ...
    public class LogFrame implements Frame 
    {
        ...
        public function LogFrame(allowLogUpload:Boolean)
        {
            ...
            try
            {
                ...
                mega = ((Math.pow(2, 20) * 0) + (0x0400 * 250));
            ...
            try
            {
                switch (true)
                {
                    ...
                    case (msg is MouseMessage):
                        ...
                        {
                            _local_2 = MouseMessage(msg).target;
                            if (_local_2 != null)
                            {
                                while (((_local_2.parent) && (!((_local_2 is ICustomUnicNameGetter)))))
                                {
                                    _local_2 = _local_2.parent;
                                };
                                if ((_local_2 is ICustomUnicNameGetter))
                                {
                                    this._log(LogTypeEnum.MOUSE, new MouseInteraction(ICustomUnicNameGetter(_local_2).customUnicName, getQualifiedClassName(msg), MouseMessage(msg).mouseEvent.stageX, MouseMessage(msg).mouseEvent.stageY));
                                };
                            };
                        };
                        break;
