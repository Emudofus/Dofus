package com.ankamagames.jerakine.utils.misc
{
    ...
    public class AsyncJPGEncoder 
    {
        ...
        public function AsyncJPGEncoder(quality:int=50)
        {
            ...
            this.bitcode = new Vector.<BitString>(0xFFFF, true);
            this.category = new Vector.<int>(0xFFFF, true);
        ...
        private function fDCTQuant(data:Vector.<Number>, fdtbl:Vector.<Number>):Vector.<int>
        {
            ...
            while (i < I64)
            {
                ...
                this.outputfDCTQuant[int(i)] = (((fDCTQuant)>0) ? int((fDCTQuant + 0.5)) : int((fDCTQuant - 0.5)));
                i++;
            };
