package com.ankamagames.jerakine.utils.system
{
    ...
    public class SystemPopupUI extends Sprite 
    {
        ...
        private var _style_bg_color:uint = 0xFFFFFF;
        private var _style_font_color:uint = 0x555555;
        private var _style_title_color:uint = 0xDDDDDD;
        private var _style_border_color:uint = 0xAAAAAA;
        ...
        private function buildUI(destroy:Boolean=false):void
        {
            ...
            if (((this._buttons) && (this._buttons.length)))
            {
                ...
                for each (b in this._buttons)
                {
                    ...
                    btn.x = ((btnContainer.width) ? (btnContainer.width + 10) : 0);
        ...
        private function createButton(text:String):DisplayObject
        {
            ...
            btn.graphics.lineStyle(1, (this._style_border_color + 0x111111));
            btn.graphics.beginFill((this._style_title_color + 0x111111));
