package com.ankamagames.jerakine.utils.display
{
    ...
    public class Dofus1Line 
    {
        ...
        public static function getLine(x1:int, y1:int, z1:int, x2:int, y2:int, z2:int):Array
        {
            var i:int;
            var cell:Point;
            var erreurSupArrondis:int;
            var erreurInfArrondis:int;
            var beforeY:Number;
            var afterY:Number;
            var diffBeforeCenterY:Number;
            var diffCenterAfterY:Number;
            var beforeX:Number;
            var afterX:Number;
            var diffBeforeCenterX:Number;
            var diffCenterAfterX:Number;
            var y:uint;
            var x:uint;
