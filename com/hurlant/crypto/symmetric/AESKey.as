    ...
    public class AESKey extends Object implements ISymmetricKey
    {
        ...
        public function encrypt(param1:ByteArray, param2:uint = 0) : void
        {
            ...
            while (_loc_3 < (this.Nr + 1))
            {
                ...
                this.addRoundKey(this.key, _loc_3 * Nb * 4);
                _loc_3 = _loc_3 + 1;
            }
        ...
        public function dispose() : void
        {
            ...
            _loc_1 = 0;
            while (_loc_1 < this.key.length)
            {
                
                this.key[_loc_1] = _loc_2.nextByte();
                _loc_1 = _loc_1 + 1;
            }
            this.Nr = _loc_2.nextByte();
            _loc_1 = 0;
            while (_loc_1 < this.state.length)
            {
                
                this.state[_loc_1] = _loc_2.nextByte();
                _loc_1 = _loc_1 + 1;
            }
            _loc_1 = 0;
            while (_loc_1 < this.tmp.length)
            {
                
                this.tmp[_loc_1] = _loc_2.nextByte();
                _loc_1 = _loc_1 + 1;
            }
            this.key.length = 0;
            this.keyLength = 0;
