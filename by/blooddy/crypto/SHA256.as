         ...
         do
         {
            ...
            if(_loc11_>=64)
            {
               ...
               do
               {
                  ...
                  do
                  {
                     _loc27_=_loc11_+_loc14_<<24|_loc11_+_loc14_+1<<16|_loc11_+_loc14_+2<<8|_loc11_+_loc14_+3;
                     _loc29_=_loc24_+((_loc21_<<26|_loc21_>>>6)^(_loc21_<<21|_loc21_>>>11)^(_loc21_<<7|_loc21_>>>25))+(_loc21_&_loc22_^~_loc21_&_loc23_)+(256+_loc14_)+_loc27_;
                     ...
                     if(_loc14_>=64)
                     {
                        do
                        {
                           _loc25_=_loc14_-8;
                           _loc26_=_loc14_-60;
                           _loc27_=((_loc25_<<15|_loc25_>>>17)^(_loc25_<<13|_loc25_>>>19)^_loc25_>>>10)+(_loc14_-28)+((_loc26_<<25|_loc26_>>>7)^(_loc26_<<14|_loc26_>>>18)^_loc26_>>>3)+(_loc14_-64);
                           _loc29_=_loc24_+((_loc21_<<26|_loc21_>>>6)^(_loc21_<<21|_loc21_>>>11)^(_loc21_<<7|_loc21_>>>25))+(_loc21_&_loc22_^~_loc21_&_loc23_)+(256+_loc14_)+_loc27_;
                           _loc28_=((_loc17_<<30|_loc17_>>>2)^(_loc17_<<19|_loc17_>>>13)^(_loc17_<<10|_loc17_>>>22))+(_loc17_&_loc18_^_loc17_&_loc19_^_loc18_&_loc19_);
                           _loc24_=_loc23_;
                           _loc23_=_loc22_;
