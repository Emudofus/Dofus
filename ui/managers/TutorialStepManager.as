package managers
{
   ...
   public class TutorialStepManager extends Object
   {
               ...
               case TutorialConstants.TUTORIAL_STEP_EQUIP_ITEM:
                  switch(subStep)
                  {
                     case TutorialConstants.TUTORIAL_SUB_STEP_EQUIP_ITEM__OPEN_CHARACTER_SHEET:
                        ...
                        rect = this._bannerUiClass.getSlotByBtnId(_watchedComponents["InventoryButton"]).getStageRect();
                        if(displayArrow)
                        {
                           Api.highlight.highlightAbsolute(new Rectangle(rect.x,rect.y,rect.width,rect.height),1,0,5,true);
                        }
                        break;
               ...
               case TutorialConstants.TUTORIAL_STEP_EQUIP_ALL_ITEMS:
                  switch(subStep)
                  {
                     case TutorialConstants.TUTORIAL_SUB_STEP_EQUIP_ALL_ITEMS__SHOW_CHARACTER_SHEET:
                        ...
                        rect2 = this._bannerUiClass.getSlotByBtnId(_watchedComponents["InventoryButton"]).getStageRect();
                        if(displayArrow)
                        {
                           Api.highlight.highlightAbsolute(new Rectangle(rect2.x,rect2.y,rect2.width,rect2.height),1,0,5,true);
                        }
                        break;
      ...
      private function getItemSuperType(item:Object) : uint {
         ...
         {
            switch(item.livingObjectCategory)
            {
               case 1:
                  return 1;
               case 10:
