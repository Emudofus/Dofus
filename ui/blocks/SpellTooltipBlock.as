package blocks
{
    ...
    public class SpellTooltipBlock 
    {
            ...
            if (this._param.effects)
            {
                ...
                switch (zoneEffect.zoneShape)
                {
                    ...
                    case SpellShapeEnum.plus:
                        uri = (this.sysApi.getConfigEntry("config.content.path") + "gfx/characteristics/spellAreas.swf|plus");
                    ...
                    case SpellShapeEnum.star:
                        uri = (this.sysApi.getConfigEntry("config.content.path") + "gfx/characteristics/spellAreas.swf|star");
