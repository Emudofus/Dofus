package makers
{
   ...
   public class MountTooltipMaker extends Object
   {
      ...
      public function createTooltip(data:*, param:Object) : Object {
         ...
         var tooltip:Object = Api.tooltip.createTooltip(bg,"chunks/base/container.txt","chunks/base/empty.txt");
         ...
         if(nEffect)
         {
            tooltip.addBlock(new EffectTooltipBlock(mount.effectList).block);
         }
         else
         {
