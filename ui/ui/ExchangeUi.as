package ui
{
    ...
    public class ExchangeUi 
    {
        ...
        public function main(oParam:Object=null):void
        {
            ...
            this.input_kamaRight.numberMax = 0x77359400;
        ...
        public function onRelease(target:Object):void
        {
            ...
            switch (target)
            {
                ...
                case this.btnMoveAll:
                    _local_2 = new Array();
                    _local_2.push(this.modContextMenu.createContextMenuItemObject(this.uiApi.getText("ui.storage.getAll"), this.transfertAll, null, false, null, false, true));
        ...
        public function onSelectItem(target:Object, selectMethod:uint, isNewSelection:Boolean):void
        {
            ...
            {
                case this.gd_right:
                    _local_4 = this.gd_right.selectedItem;
                    if (selectMethod == SelectMethodEnum.DOUBLE_CLICK)
                    {
                        this.sysApi.sendAction(new ExchangeObjectMove(_local_4.objectUID, -1));
                    }
                    else
                    {
                        if (selectMethod == SelectMethodEnum.CTRL_DOUBLE_CLICK)
                        {
                            this.sysApi.sendAction(new ExchangeObjectMove(_local_4.objectUID, -(_local_4.quantity)));
                        }
                        else
                        {
                            ...
                            {
                                this.onObjectSelected(_local_4);
                            };
                        };
                    };
                    break;
                case this.gd_left:
                    _local_5 = this.gd_left.selectedItem;
                    this.onObjectSelected(_local_5);
                    break;
            };
        }
        ...
        public function onRightClick(target:Object):void
        {
            ...
            {
                if (target == this.playerRightLook)
                {
                    this.sysApi.sendAction(new DisplayContextualMenu(this.playerApi.id()));
                };
            };
        ...
        private function addItemListInRightGrid(pItemWrapperList:Object):void
        {
            ...
            {
                this._leftExchangePods = (this._leftExchangePods + (wrapper.quantity * wrapper.weight));
                this._rightExchangePods = (this._rightExchangePods - (wrapper.quantity * wrapper.weight));
        ...
        private function updateEstimatedValue(pItemsList:Array, pKamas:int, pLabel:Label):void
        {
            ...
            {
                if (pLabel == this.lbl_estimated_value_right)
                {
