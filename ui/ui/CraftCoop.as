package ui
{
   ...
   public class CraftCoop extends Craft
   {
      ...
      override public function main(args:Object) : void {
         ...
         this.ed_otherPlayer.mouseEnabled = true;
         this.ed_otherPlayer.handCursor = true;
