package ui
{
   ...
   public class CharacterHeader extends Object
   {
      ...
      private function playerDisplay() : void {
         ...
         {
            this.lbl_abo.text = this.uiApi.getText("ui.common.until",this.timeApi.getDate(this.sysApi.getPlayerManager().subscriptionEndDate,true) + " " + this.timeApi.getClock(this.sysApi.getPlayerManager().subscriptionEndDate,true,true));
         }
         else
         {
