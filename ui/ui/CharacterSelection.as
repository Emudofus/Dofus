package ui
{
    ...
    public class CharacterSelection 
    {
            ...
            if (this._nbCharacters != 0)
            {
                if (!(this.charaWheel.isWheeling))
                {
                    ...
                    else
                    {
                        ...
                        this.btn_play.disabled = true;
                        this.sysApi.sendAction(new CharacterSelection(this.getIdCharByNumber(i), false));
        ...
        public function updateCharacterLine(data:*, componentsRef:*, selected:Boolean):void
        {
            if (data)
            {
                if (data.character.bonusXp > 1)
                {
                    ...
                    componentsRef.lbl_gridName.width = 0x0101;
                }
                else
                {
        ...
        public function newArticles(availiableArticles:Boolean):void
        {
            this.btn_articles.visible = availiableArticles;
        }
        ...
        public function onRelease(target:Object):void
        {
            ...
            switch (target)
            {
                ...
                case this.grid_character:
                    break;
                default:
                    _local_2 = this._aCharactersList.length;
                    if (_local_2 <= 5)
                    {
                        i = 0;
                        while (i < _local_2)
                        {
                            ...
                            {
                                t = ((2 * Math.PI) / _local_2);
                                sens = (i - this.getSelectedCharacterIndex());
                                if (Math.abs(sens) > (_local_2 / 2))
                                {
                                    if (sens > 0)
                                    {
                                        sens = (sens - _local_2);
        ...
        public function onCharactersListUpdated(charactersList:Object):void
        {
            ...
            else
            {
                ...
                {
                    if ((((this._nbCharacters > 3)) && ((this._nbCharacters < 6))))
                    {
        ...
        public function onPackRestrictedSubArea(subAreaId:uint):void
        {
            ...
            {
                if (!(this.uiApi.getUi("unavailableCharacterPopup")))
                {
