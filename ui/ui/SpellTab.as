package ui
{
    ...
    import d2hooks.SpellUpgradeSuccess;
    import d2hooks.SpellUpgradeFail;
    import d2hooks.SpellList;
    import d2hooks.CharacterStatsList;
    import d2hooks.SpellForgotten;
    ...
    public class SpellTab 
    {
        ...
        public function main(oParam:Object=null):void
        {
            ...
            for each (swInven in this._spellsInventory)
            {
                tempInventorySpells[swInven.id] = swInven;
            };
        ...
        private function sortOnMinPlayerLevel(pSpellA:Object, pSpellB:Object):Number
        {
            ...
            var aMinPlayerLevel:uint;
            var bMinPlayerLevel:uint;
            if (pSpellA.id != 0)
            {
        ...
        private function filterSpellByType():void
        {
            ...
            var normalAttackPresent:Boolean;
        ...
        public function onRelease(target:Object):void
        {
            ...
            var spellData:Spell;
            var realSpellLevel:int;
            var mySpellPoints:int;
            var myLevel:int;
                ...
                default:
                    if (target.name.indexOf("btn_increase") != -1)
                    {
                        ...
                        for each (lvl in levels)
                        {
                            ...
                            {
                                if (pointsRequired > mySpellPoints)
                                {
