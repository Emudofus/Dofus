package ui
{
    ...
    public class InteractiveElementTooltipUi 
    {
        ...
        public function main(oParam:Object=null):void
        {
            ...
            var numStars:int;
            var i:int;
            var disabledSkillsY:Number;
            var collectInfos:Object;
        ...
        private function getMaxWidth():Number
        {
            ...
            {
                if ((((this.ctr_stars.width > this.lbl_elementName.width)) && ((this.ctr_stars.width > this.lbl_resources_qty.width))))
                {
                    maxWidth = this.ctr_stars.width;
                }
                else
                {
                    if ((((this.lbl_resources_qty.width > this.ctr_stars.width)) && ((this.lbl_resources_qty.width > this.lbl_elementName.width))))
                    {
