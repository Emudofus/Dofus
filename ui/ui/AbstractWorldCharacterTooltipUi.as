                ...
                if (data.hasOwnProperty("wingsEffect"))
                {
                    ...
                    else
                    {
                        if (data.wingsEffect == 1)
                        {
                            ...
                            {
                                tx_alignment.filters = new Array(new GlowFilter(0xFFFFFF, 1, 5, 5, 1, 3));
                                tx_alignmentBottom.filters = new Array(new GlowFilter(0xFFFFFF, 1, 5, 5, 1, 3));
                            ...
                            else
                            {
                                if (alignmentInfos.alignmentSide == 2)
                                {
                                    tx_alignment.filters = new Array(new GlowFilter(0xFF0018, 1, 10, 10, 2, 3));
                                    tx_alignmentBottom.filters = new Array(new GlowFilter(0xFF0018, 1, 10, 10, 2, 3));
                                ...
                                {
                                    if (alignmentInfos.alignmentSide == 3)
                                    {
