                ...
                case this.gd_shop:
                    ...
                    switch (selectMethod)
                    {
                        case SelectMethodEnum.CLICK:
                            this.sysApi.dispatchHook(ClickItemShopHV, _local_4.itemWrapper, _local_4.price);
                            this.showTransfertUI(true);
                            break;
                        case SelectMethodEnum.DOUBLE_CLICK:
                            this.sysApi.sendAction(new ExchangeObjectModifyPriced(_local_4.itemWrapper.objectUID, -1, _local_4.price));
                            break;
                        case SelectMethodEnum.CTRL_DOUBLE_CLICK:
                            this.sysApi.sendAction(new ExchangeObjectModifyPriced(_local_4.itemWrapper.objectUID, -(_local_4.itemWrapper.quantity), _local_4.price));
                            break;
                        case SelectMethodEnum.ALT_DOUBLE_CLICK:
                            this._objectToRemove = _local_4;
                            this.modCommon.openQuantityPopup(1, _local_4.itemWrapper.quantity, _local_4.itemWrapper.quantity, this.onValidQty);
                            break;
                    };
                    break;
                case this.cbFilter:
