        ...
        public function onRollOver(target:Object):void
        {
            ...
            switch (target)
            {
                ...
                case this.btn_tabAlliance:
                    ...
                    break;
                case this.btn_tabSpouse:
                    _local_7 = this.socialApi.getSpouse();
                    if (_local_7 != null)
                    {
                        tooltipText = this.uiApi.processText(this.uiApi.getText("ui.common.spouse"), (((_local_7.sex > 0)) ? "f" : "m"), true);
                    }
                    else
                    {
