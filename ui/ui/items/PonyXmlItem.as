    ...
    public class PonyXmlItem 
    {
        ...
        public function update(newData:TaxCollectorWrapper, selected:Boolean, force:Boolean=false):void
        {
            ...
            if (newData)
            {
                ...
                worldMapId = this.dataApi.getSubArea(this.data.subareaId).worldmap.id;
                this.lbl_ponyLoc.text = (((((((((((((this.dataApi.getSubArea(this._data.subareaId).name + " ({taxcollectorPosition,") + this._data.mapWorldX) + ",") + this._data.mapWorldY) + ",") + worldMapId) + ",") + this._data.uniqueId) + "::") + this._data.mapWorldX) + ",") + this._data.mapWorldY) + "})");
                ...
                else
                {
                    ...
                    {
                        if (this._data.state == TaxCollectorStateEnum.STATE_WAITING_FOR_HELP)
                        {
