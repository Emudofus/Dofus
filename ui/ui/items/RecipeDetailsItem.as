package ui.items
{
   ...
   public class RecipeDetailsItem extends Object
   {
      
      public function RecipeDetailsItem() {
         super();
      }
      ...
      public function update(data:*, selected:Boolean) : void {
         ...
         var l:* = 0;
         var ingredientQty:* = 0;
         var hasItemsToTransfert:* = false;
         var itemIsInBag:* = false;
         this._data = data;
         if(data)
         {
            ...
            while(i < l)
            {
               ...
               else if(ingredientQty < this._data.quantities[ii])
               {
         ...
         switch(target)
         {
            ...
            case this.tx_ingredientStateIcon8:
               if(target.uri)
               {
                  ...
                  else if(target.uri.fileName == uriBagIngredients.fileName)
                  {
            ...
            case this.tx_background:
               if(this._data)
               {
                  ...
                  else if(this._slotMax < this._data.ingredients.length)
                  {
                     text = text + this.uiApi.getText("ui.jobs.difficulty3");
                  }
                  else if(this._missingIngredients)
                  {
                     text = text + this.uiApi.getText("ui.craft.dontHaveAllIngredient");
                  }
                  else if(this._slotMax - this._data.ingredients.length >= 4)
                  {
