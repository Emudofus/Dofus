        ...
        private function onKeyUp(target:Object, keyCode:int):void
        {
            switch (true)
            {
                case (keyCode == Keyboard.SPACE):
                    this.addNumber(10);
                    return;
                case (((keyCode == 96)) || ((keyCode == 48))):
                    this.addNumber(0);
                    return;
                case (((keyCode == 97)) || ((keyCode == 49))):
                    this.addNumber(1);
                    return;
                case (((keyCode == 98)) || ((keyCode == 50))):
                    this.addNumber(2);
                    return;
                case (((keyCode == 99)) || ((keyCode == 51))):
                    this.addNumber(3);
                    return;
                case (((keyCode == 100)) || ((keyCode == 52))):
                    this.addNumber(4);
                    return;
                case (((keyCode == 101)) || ((keyCode == 53))):
                    this.addNumber(5);
                    return;
                case (((keyCode == 102)) || ((keyCode == 54))):
                    this.addNumber(6);
                    return;
                case (((keyCode == 103)) || ((keyCode == 55))):
                    this.addNumber(7);
                    return;
                case (((keyCode == 104)) || ((keyCode == 56))):
                    this.addNumber(8);
                    return;
                case (((keyCode == 105)) || ((keyCode == 57))):
                    this.addNumber(9);
                    return;
            };
        }
