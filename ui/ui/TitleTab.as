package ui
{
    ...
    public class TitleTab 
    {
        ...
        {
            var myTitle:Object;
            var myOrnament:Object;
            var myTitles:Object;
            var myOrnaments:Object;
        ...
        private function updateGrid(tab:int=0, force:Boolean=false):void
        {
            ...
            {
                if ((((this._nCurrentTab == TAB_ORNAMENT)) || (((force) && ((tab == TAB_ORNAMENT))))))
                {
                    orns = new Array();
                    if (!(this._searchCriteria))
                    {
        ...
        public function onSelectItem(target:Object, selectMethod:uint, isNewSelection:Boolean):void
        {
            ...
            if (selectMethod != GridItemSelectMethodEnum.AUTO)
            {
                ...
                {
                    case this.gd_titles:
                        _local_4 = target.selectedItem.id;
                        if (((!((_local_4 == this._titleId))) || (this._waitingForTooltipUpdate)))
                        {
                            this._waitingForTooltipUpdate = false;
                            this._titleId = _local_4;
                            this.displayTooltip(true, false);
                        };
                        break;
                    case this.gd_orns:
                        _local_5 = target.selectedItem.id;
                        if (((!((_local_5 == this._ornamentId))) || (this._waitingForTooltipUpdate)))
                        {
                            this._waitingForTooltipUpdate = false;
                            this._ornamentId = _local_5;
