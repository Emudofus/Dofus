package ui
{
   ...
   public class AbstractCartographyUi extends Object
   {
      ...
      protected function addCustomFlag(pX:int, pY:int) : void {
         ...
         this.sysApi.dispatchHook(AddMapFlag,flagId,this.uiApi.getText("ui.cartography.customFlag") + " (" + pX + "," + pY + ")",this._currentWorldId,pX,pY,16768256);
      }
