package ui
{
   ...
   public class DocumentBase extends Object
   {
      ...
      private static var EXP_IMG:RegExp;
      
      private static var EXP_DIESE:RegExp;
      
      private static var EXP_LINK:RegExp;
      ...
      protected function linkHandler(textEvent:String) : void {
         ...
         else if(param[0] == GO_TO_COORDINATE)
         {
            px = param[1];
            py = param[2];
            this.sysApi.dispatchHook(AddMapFlag,"flag_srv" + CompassTypeEnum.COMPASS_TYPE_SIMPLE + "_pos_" + px + "_" + py,px + "," + py,this.mapApi.getCurrentWorldMap().id,px,py,5605376,true);
         }
