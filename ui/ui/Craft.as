package ui
{
    ...
    import d2hooks.ExchangeItemAutoCraftRemaining;
    ...
    import d2hooks.ExchangeCraftSlotCountIncreased;
    ...
    public class Craft 
    {
        ...
        {
            var recipeToCheck:Array;
            var re:Object;
            var pass:Boolean;
            var component:Object;
            var componentPass:Boolean;
            var recipeComponent:Object;
            var matchingRecipes:Array = new Array();
            if (pNbSlots == -1)
            {
                recipeToCheck = this._recipes;
            }
            else
            {
                recipeToCheck = this._getRecipeBySlots(pNbSlots);
            };
            for each (re in recipeToCheck)
            {
                pass = true;
        ...
        protected function displayPlayerEntity(look:Object, entityDisplayer:Object, direction:int):void
        {
            ...
            entityDisplayer.entityScale = 1.5;
