package ui
{
    ...
    public class CharacterSheetUi 
    {
        ...
        public function main(params:Object):void
        {
            ...
            this.uiApi.addComponentHook(this.tx_alignmentIcon, ComponentHookList.ON_RELEASE);
            this.tx_alignmentIcon.handCursor = true;
            this.uiApi.addComponentHook(this.tx_xpGauge, ComponentHookList.ON_ROLL_OVER);
            this.uiApi.addComponentHook(this.tx_xpGauge, ComponentHookList.ON_ROLL_OUT);
            this.uiApi.addComponentHook(this.tx_energyGauge, ComponentHookList.ON_ROLL_OVER);
            this.uiApi.addComponentHook(this.tx_energyGauge, ComponentHookList.ON_ROLL_OUT);
            ...
            this.uiApi.addComponentHook(this.lbl_statPointsTitle, ComponentHookList.ON_ROLL_OVER);
            this.uiApi.addComponentHook(this.lbl_statPointsTitle, ComponentHookList.ON_ROLL_OUT);
            this.uiApi.addComponentHook(this.lbl_statPoints, ComponentHookList.ON_ROLL_OVER);
            this.uiApi.addComponentHook(this.lbl_statPoints, ComponentHookList.ON_ROLL_OUT);
            var i:uint = 1;
            while (i < 4)
            {
                this.uiApi.addComponentHook(this[("tx_jobIcon" + i)], ComponentHookList.ON_RELEASE);
                this.uiApi.addComponentHook(this[("tx_subjobIcon" + i)], ComponentHookList.ON_RELEASE);
                this.uiApi.addComponentHook(this[("tx_jobIcon" + i)], ComponentHookList.ON_ROLL_OVER);
                this.uiApi.addComponentHook(this[("tx_subjobIcon" + i)], ComponentHookList.ON_ROLL_OVER);
                this.uiApi.addComponentHook(this[("tx_jobIcon" + i)], ComponentHookList.ON_ROLL_OUT);
                this.uiApi.addComponentHook(this[("tx_subjobIcon" + i)], ComponentHookList.ON_ROLL_OUT);
        ...
        public function updateStatLine(data:*, componentsRef:*, selected:Boolean):void
        {
            var initiative:int;
            var total:int;
            if (!(this._componentList[componentsRef.lbl_nameStat.name]))
            {
                this.uiApi.addComponentHook(componentsRef.lbl_nameStat, ComponentHookList.ON_ROLL_OUT);
                this.uiApi.addComponentHook(componentsRef.lbl_nameStat, ComponentHookList.ON_ROLL_OVER);
            };
            this._componentList[componentsRef.lbl_nameStat.name] = data;
            if (data)
            {
                if (data.gfxId != "null")
                {
        ...
        public function updateCaracLine(data:*, componentsRef:*, selected:Boolean):void
        {
            ...
            if (data)
            {
                ...
                while (i < statpoints.length)
                {
                    ...
                    {
                        if (this._characterCharacteristics.additionnalPoints >= statpoints[i][1])
                        {
                            componentsRef.btn_plus.visible = true;
                        };
                    };
        ...
        public function updateAdvancedLine(data:*, componentsRef:*, selected:Boolean):void
        {
            ...
            var bonus:int;
            var total:int;
            if (!(this._componentList[componentsRef.lbl_base.name]))
            {
                this.uiApi.addComponentHook(componentsRef.lbl_base, ComponentHookList.ON_ROLL_OUT);
                this.uiApi.addComponentHook(componentsRef.lbl_base, ComponentHookList.ON_ROLL_OVER);
            };
            this._componentList[componentsRef.lbl_base.name] = data;
            if (data)
            {
                if ((data is String))
                {
                ...
                else
                {
                    ...
                    base = (data.base + data.additionnal);
        ...
        private function statsUpdate():void
        {
            ...
            for (i in caracs)
            {
                ...
                this._caracList[i].additionnal = caracs[i].additionnal;
                ...
                if (caracs[i].additionnal < ProtocolConstantsEnum.MAX_ADDITIONNAL_PER_CARAC)
                {
            ...
            if (this._someStatsMayBeScrolled)
            {
                this.lbl_statPoints.text = String((this._characterCharacteristics.statsPoints + this._characterCharacteristics.additionnalPoints));
            }
            else
            {
        ...
        public function onRelease(target:Object):void
        {
            switch (target)
            {
                ...
                default:
                    ...
                    {
                        this.uiApi.loadUi("statBoost", "statBoost", [this._componentList[target.name].id, this._componentList[target.name].numId, this._someStatsMayBeScrolled]);
                    };
            };
        }
        ...
        public function onRollOver(target:Object):void
        {
            ...
            switch (target)
            {
                ...
                case this.lbl_statPointsTitle:
                    ...
                    break;
                case this.lbl_statPoints:
                    if (((this._someStatsMayBeScrolled) && ((this._characterCharacteristics.additionnalPoints > 0))))
                    {
                        text = ((("" + this._characterCharacteristics.statsPoints) + " + ") + this._characterCharacteristics.additionnalPoints);
                    };
                    break;
                case this.btn_title:
                ...
                default:
                    ...
                    else
                    {
                        ...
                        {
                            if (target.name.indexOf("lbl_base") != -1)
                            {
                                data = this._componentList[target.name];
                                if (((((data) && (!((data is String))))) && (data.hasOwnProperty("base"))))
                                {
        ...
        {
            var parsedStat:String = ((((((((((((((this.uiApi.getText("ui.common.base") + "+") + this.uiApi.getText("ui.charaSheet.additionnal")) + this.uiApi.getText("ui.common.colon")) + stat.base) + "+") + stat.additionnal) + "\n") + this.uiApi.getText("ui.common.equipement")) + this.uiApi.getText("ui.common.colon")) + stat.stuff) + "\n") + this.uiApi.getText("ui.common.boost")) + this.uiApi.getText("ui.common.colon")) + stat.boost);
            return (parsedStat);
        }
