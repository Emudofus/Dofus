package ui
{
    ...
    public class ConfigShortcutPopup 
    {
            ...
            switch (target)
            {
                ...
                case this.btnOk:
                    if (((!(this._actualBind)) || (!(this._actualBind.equals(this._currentBind)))))
                    {
                        ...
                        {
                            if (this.bindsApi.bindIsRegister(this._currentBind))
                            {
        ...
        private function onKeyboardShortcut(bind:Bind, keyCode:uint):void
        {
            ...
            {
                if (((((this._currentShortcut.textfieldEnabled) && (!((this._currentShortcut as Shortcut).defaultBind.equals(bind))))) && (!(((((((bind.shift) && (bind.ctrl))) || (((bind.alt) && (!(bind.ctrl)))))) || (((bind.ctrl) && (!(bind.alt)))))))))
                {
                    switch (keyCode)
                    {
