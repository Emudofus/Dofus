package ui
{
   ...
   public class PresetUi extends Object
   {
      ...
      public function onRelease(target:Object) : void {
         ...
         var iconId:uint = 0;
         var i:* = 0;
         var uids:Vector.<uint> = null;
         var positions:Vector.<uint> = null;
         switch(target)
         {
            case this.btn_new:
            ...
            case this.btn_save:
               ...
               if(id != -1)
               {
                  ...
                  {
                     this.sysApi.sendAction(new InventoryPresetSave(id,iconId,this._newItems));
                  }
                  else
                  {
                     ...
                     this.sysApi.sendAction(new InventoryPresetSaveCustom(id,iconId,uids,positions));
      ...
      public function onItemRollOver(target:Object, item:Object) : void {
         ...
         var uiObject:Object = null;
         var equipmentUi:EquipmentUi = null;
