        ...
        public function onTextureReady(target:Object):void
        {
            ...
            switch (target)
            {
                ...
                case this.tx_emblemUp:
                    _local_2 = this.dataApi.getEmblemSymbol(this._myGuild.upEmblem.idEmblem);
                ...
                case this.tx_emblemUpOld:
                    _local_3 = this.dataApi.getEmblemSymbol(this._guildEmblem.upEmblem.idEmblem);
                    if (_local_3.colorizable)
                    {
                ...
                case this.tx_emblemUpNew:
                    _local_4 = this.dataApi.getEmblemSymbol(this._myGuild.upEmblem.idEmblem);
                    if (_local_4.colorizable)
                    {
