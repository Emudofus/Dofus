package ui
{
   ...
   public class ModuleMarketplace extends Object
   {
      ...
      private static const URL_REGEX:RegExp;
      
      private static const WHITESPACE_TRIM_REGEX:RegExp;
      ...
      public function unload() : void {
         ...
         this.uiApi.getUi("subConfigUi").uiClass.update();
      }
      ...
      public function onRelease(target:Object) : void {
         ...
         var oldUrls:* = undefined;
         var urls:Vector.<String> = null;
         ...
         switch(target)
         {
            case this.btn_close:
               ...
               break;
            case this.btn_fetch:
               url = this.icb_url.input.text;
               if(URL_REGEX.test(url))
               {
                  this.sysApi.sendAction(new ModuleListRequest(url));
               }
               else
               {
      ...
      private function filterModules(searchCriteria:String) : void {
         var reusingDataProvider:* = false;
         var moduleList:Object = null;
         var filteredModuleList:Array = null;
         var module:Object = null;
         if(searchCriteria)
         {
