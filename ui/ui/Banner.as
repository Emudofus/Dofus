package ui
{
   ...
   public class Banner extends Object
   {
      ...
      public function main(spellList:Array) : void {
         ...
         this.sysApi.addHook(d2hooks.OpenInventory,this.onOpenInventory);
         ...
         this.sysApi.addHook(d2hooks.ShowMonstersInfo,this.onShowMonstersInfo);
         ...
         this.ed_coloredArtwork.width = this.ctr_artwork.width;
         this.ed_coloredArtwork.height = this.ctr_artwork.height;
         this.ed_coloredArtwork.autoSize = true;
         ...
         var krosmasterActive:Boolean = false;
         ...
         this.onAddBannerButton(ID_BTN_OGRINE,"btn_ogrine",this.onWebAction,this.uiApi.getText("ui.banner.webBrowser"),this.bindsApi.getShortcutBindStr("openWebBrowser"));
      ...
      private function headDisplay(pLook:Object = null) : void {
         ...
         var subEntityColors:Object = null;
         var colorStr:String = null;
         var color:* = undefined;
         var artworkLookStr:String = null;
         var look:Object = null;
         var playerId:* = 0;
         var look2:Object = null;
         var isCreature:* = false;
         var isIncarnation:* = false;
         ...
         if(this._locketMode == LOCKET_ARTWORK)
         {
            ...
            {
               this.ed_coloredArtwork.scale = 1;
      ...
      private function showSpritePortrait(pLook:Object, pIsCreature:Boolean, pIsIncarnation:Boolean) : void {
         ...
         if((this.ed_coloredArtwork.look) && (!this.ed_coloredArtwork.look.getSubEntity(6,0)) && (look.getSubEntity(6,0)))
         {
            tmpLook = this.ed_coloredArtwork.look.clone();
            tmpLook.addSubEntity(6,0,look.getSubEntity(6,0).clone());
            auraAdded = tmpLook.equals(look);
         }
         if((!auraAdded) && ((!this.ed_coloredArtwork.look) || (!this.ed_coloredArtwork.look.equals(look))))
         {
            ...
            {
               this.ed_coloredArtwork.scale = 0.9;
               this.ed_coloredArtwork.yOffset = 0;
            }
            else if(((!this.playerApi.isInFight()) || (this.fightApi.getCurrentPlayedFighterId() == this.playerApi.id())) && (pIsIncarnation))
            {
               this.ed_coloredArtwork.scale = 1;
               this.ed_coloredArtwork.yOffset = 0;
            }
            else
            {
               ...
               {
                  case 2558:
                     this.ed_coloredArtwork.scale = 2;
                     this.ed_coloredArtwork.yOffset = 0;
                     break;
                  case 2666:
                     this.ed_coloredArtwork.scale = 2;
                     this.ed_coloredArtwork.yOffset = 20;
                     break;
                  case 2410:
                     this.ed_coloredArtwork.scale = 2;
      ...
      private function showMonsterArtwork(boneId:int) : void {
         ...
         else if(this._locketMode == LOCKET_ARTWORK)
         {
         ...
         if(this.dropValidator(target,data,source))
         {
            switch(this._sTabGrid)
            {
               ...
               case ITEMS_TAB:
                  ...
                  else if(data.simplyfiedQualifiedClassName == "PresetWrapper")
                  {
                  ...
                  else if(data.simplyfiedQualifiedClassName == "EmoteWrapper")
                  {
                  ...
                  else if(data.simplyfiedQualifiedClassName == "SmileyWrapper")
                  {
      ...
      private function onArenaUpdateRank(rank:int, fights:int, wonFights:int) : void {
      ...
      private function onHouseInformations(houses:Object) : void {
         var daHouse:AccountHouseInformations = null;
      ...
      private function updatePrismIcon(pPrismSubAreaInformation:PrismSubAreaWrapper) : void {
         ...
         else if(pPrismSubAreaInformation.mapId == -1)
         {
            this.miniMap.removeMapElement(this.miniMap.getMapElement(prismId));
         }
      ...
      public function onGameFightTurnStart(id:int, waitTime:int, picture:Boolean) : void {
         if(id == this.fightApi.getCurrentPlayedFighterId())
         {
      ...
      private function onPhoenixUpdate() : void {
         var flagId:* = undefined;
         var phoenixesMaps:Object = null;
         var mapId:* = 0;
         var gfxPath:String = null;
      ...
      public function onPress(target:Object) : void {
         switch(target)
         {
            ...
            case this.btn_showMonstersInfo:
               ...
               {
                  this.sysApi.sendAction(new d2actions.ShowMonstersInfo(false));
               }
               break;
         }
      }
      ...
      public function onSelectItem(target:Object, selectMethod:uint, isNewSelection:Boolean) : void {
         var _spellShortcut:Object = null;
         var item:Object = null;
               ...
               switch(this._sTabGrid)
               {
                  case SPELLS_TAB:
                     ...
                     if(_spellShortcut)
                     {
                        ...
                        {
                           this.sysApi.dispatchHook(OpenSpellInterface,_spellShortcut.id);
                        }
                        else if(target.selectedItem.active)
                        {
                           this.sysApi.sendAction(new GameFightSpellCast(_spellShortcut.id));
                        }
                        
                     }
                     else if(this.sysApi.isFightContext())
                     {
      ...
      private function onChangeXpGauge(param:uint) : void {
         ...
         switch(param)
         {
            ...
            default:
               ...
               jobInfo = this.jobsApi.getJobExperience(jobs[param - JOB_GAUGE]);
               if(jobInfo.currentLevel == 100)
               {
                  value = 1;
                  floor = 0;
      ...
      private function flagCurrentMap() : void {
         ...
         this.sysApi.dispatchHook(AddMapFlag,flagId,this.uiApi.getText("ui.cartography.customFlag") + " (" + p.posX + "," + p.posY + ")",p.worldMap,p.posX,p.posY,16768256,true);
      }
      ...
      private function updateMinimap(map:Object) : void {
         var worldmap:Object = null;
         var hintCatId:Object = null;
         ...
         var gfxPath:String = null;
         var hint:Object = null;
         var nbHintCategories:* = 0;
         var h:* = 0;
         var flagList:* = undefined;
         var flag:Object = null;
         var ts:* = NaN;
         var ts2:* = NaN;
         var prismIconInfo:Object = null;
         var cat:* = 0;
         ...
         if(this._lastWorldMapInfo != worldmap)
         {
            ...
            {
               this._flags[this._currentWorldId + "_" + flag.id] = this.miniMap.addIcon("layer_8",flag.id,gfxPath + "icons/assets.swf|point0",flag.position.x,flag.position.y,this._mapIconScale,flag.legend,true,flag.color);
            }
      ...
      public function onItemRollOver(target:Object, item:Object) : void {
         ...
         else if((target == this.gd_btnUis) || (target == this.gd_additionalBtns))
         {
            text = item.data.name;
      ...
      public function onItemRightClick(target:Object, item:Object) : void {
         ...
         var disabled:* = false;
         var spellTS:Object = null;
         var items:Array = null;
         var nameText:String = null;
         var effectsText:String = null;
         var descriptionText:String = null;
         var CCText:String = null;
         var itemTooltipSettings:Object = null;
         switch(this._sTabGrid)
         {
            case ITEMS_TAB:
               data = item.data;
               ...
               contextMenu = this.menuApi.create(trueData,"item");
               disabled = false;
               ...
               if((data.usable || data.type == 1) || (data.type == 3) || (data.type == 4))
               {
                  ...
                  {
                     contextMenu.content.unshift(this.modContextMenu.createContextMenuItemObject(this.uiApi.getText("ui.krosmaster.collection"),this.goToKrosmasterUi,null,disabled));
                  }
                  ...
                  contextMenu.content.unshift(this.modContextMenu.createContextMenuItemObject(this.uiApi.getText("ui.common.use"),this.useItem,[data.id,data.type,data.slot],!disabled?!data.active:disabled));
               }
               if((data.type == 0) && (data.category == 0))
               {
                  contextMenu.content.unshift(this.modContextMenu.createContextMenuItemObject(this.uiApi.getText("ui.common.equip"),this.equipItem,[trueData],!disabled?!data.active:disabled));
               }
            ...
            case SPELLS_TAB:
               ...
               spellTS = this.getSpellTooltipSettings();
               items = new Array();
               nameText = this.uiApi.getText("ui.common.name");
               effectsText = this.uiApi.processText(this.uiApi.getText("ui.common.effects"),"",false);
               descriptionText = this.uiApi.getText("ui.common.description");
               CCText = this.uiApi.getText("ui.common.CC_EC");
               items.push(this.modContextMenu.createContextMenuItemObject(this.uiApi.getText("ui.common.tooltip"),null,null,false,[this.modContextMenu.createContextMenuItemObject(nameText,this.onSpellTooltipDisplayOption,["header"],false,null,spellTS.header,false),this.modContextMenu.createContextMenuItemObject(effectsText,this.onSpellTooltipDisplayOption,["effects"],false,null,spellTS.effects,false),this.modContextMenu.createContextMenuItemObject(CCText,this.onSpellTooltipDisplayOption,["CC_EC"],false,null,spellTS.CC_EC,false),this.modContextMenu.createContextMenuItemObject(descriptionText,this.onSpellTooltipDisplayOption,["description"],false,null,spellTS.description,false)],false),this.modContextMenu.createContextMenuItemObject(this.uiApi.getText("ui.common.remove"),this.onRemoveSpell,[data.slot],false));
               this.modContextMenu.createContextMenu(items);
               break;
         }
      }
      ...
      public function equipItem(item:Object) : void {
         ...
         if(freeSlot > -1)
         {
            this.sysApi.sendAction(new ObjectSetPosition(item.objectUID,freeSlot,1));
         }
      }
      ...
      public function onShortcut(s:String) : Boolean {
         ...
         switch(s)
         {
            ...
            case ShortcutHookListEnum.SHOW_MONSTERS_INFO:
               this.sysApi.sendAction(new d2actions.ShowMonstersInfo());
               return true;
            default:
               return false;
         }
      ...
      public function onPlayedCharacterLookChange(pLook:Object) : void {
         ...
         if((this._locketMode == LOCKET_ARTWORK) || (this._locketMode == LOCKET_SPRITE))
         {
            ...
            else if(this.playerApi.isInFight())
            {
               playerId = this.getPlayerId();
               look = this.utilApi.getLookFromContext(playerId);
               if(!look)
      ...
      private function onMapComplementaryInformationsData(map:Object, subAreaId:uint, show:Boolean) : void {
         ...
         else if((this._locketMode == LOCKET_SPRITE) && (!this._locketInitialized))
         {
            this.switchLocketContent(this._locketMode,true);
         }
      ...
      private function onGameRolePlayPlayerLifeStatus(status:uint, hardcore:uint) : void {
         ...
         if((status == PlayerLifeStatusEnum.STATUS_PHANTOM) || (status == PlayerLifeStatusEnum.STATUS_TOMBSTONE))
         {
            ...
            if(look)
            {
               ...
               else if((this._locketMode == LOCKET_SPRITE) && (this.ed_coloredArtwork.look) && (!this.ed_coloredArtwork.look.equals(look)))
               {
                  this.showSpritePortrait(look,this.utilApi.isCreature(playerId),this.utilApi.isIncarnation(playerId));
               }
      ...
      private function onFlagAdded(flagId:String, worldMapId:int, x:int, y:int, color:int, flagLegend:String) : void {
         ...
         if((this._locketMode == LOCKET_MINIMAP) && (this.mapApi.getCurrentWorldMap().id == worldMapId))
         {
            ...
            {
               this._flags[flagKey] = this.miniMap.addIcon("layer_8",flagId,this.sysApi.getConfigEntry("config.gfx.path") + "icons/assets.swf|point0",x,y,this._mapIconScale,flagLegend,true,color);
            }
            else
            {
      ...
      private function openInventory() : void {
         ...
         {
            this.sysApi.sendAction(new d2actions.OpenInventory());
         }
      }
      ...
      private function onWebAction() : void {
         ...
         {
            this.sysApi.dispatchHook(OpenWebPortal,WebLocationEnum.WEB_LOCATION_OGRINE);
         }
      }
