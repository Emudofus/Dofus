package ui
{
   ...
   public class EstateAgency extends Object
   {
         ...
         switch(target)
         {
            ...
            case this.btn_filter:
               ...
               if(!this._estateType)
               {
                  ...
                  this.sysApi.sendAction(new HouseToSellFilter(areaId,this._houseFilters[1],this._houseFilters[0],skillId,this._houseFilters[4]));
               ...
               else
               {
                  ...
                  this.sysApi.sendAction(new PaddockToSellFilter(areaId,this._paddockFilters[1] * 5,this._paddockFilters[0] * 5,this._paddockFilters[4]));
