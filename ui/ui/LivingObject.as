package ui
{
    ...
    public class LivingObject 
    {
        ...
        public function main(param:Object):void
        {
            ...
            this.sysApi.addHook(LivingObjectDissociate, this.onLivingObjectDissociate);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                this.sysApi.sendAction(new LivingObjectDissociate(this._item.objectUID, this._item.position));
                            }
                            else
                            {
