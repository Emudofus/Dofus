package ui
{
    ...
    public class WorldRpMonstersGroupTooltipUi 
    {
        ...
        private function getMaxWidth():int
        {
            ...
            {
                if ((((((((this.lbl_level.width > this.ctr_stars.width)) && ((this.lbl_level.width > this.lbl_monsterList.width)))) && ((this.lbl_level.width > this.lbl_monsterXp.width)))) && ((this.lbl_level.width > this.lbl_disabledMonsterList.width))))
                {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (((((((((((this.lbl_disabledMonsterList.visible) && ((this.lbl_disabledMonsterList.width > this.lbl_monsterXp.width)))) && ((this.lbl_disabledMonsterList.width >= this.lbl_disabledMonsterList.width)))) && ((this.lbl_disabledMonsterList.width > this.lbl_monsterList.width)))) && ((this.lbl_disabledMonsterList.width >= this.ctr_stars.width)))) && ((this.lbl_disabledMonsterList.width > this.lbl_level.width))))
                            {
                                maxValue = this.lbl_disabledMonsterList.width;
                            }
                            else
                            {
                                if (((((((((this.lbl_monsterXp.visible) && ((this.lbl_monsterXp.width > this.ctr_stars.width)))) && ((this.lbl_monsterXp.width > this.lbl_monsterList.width)))) && ((this.lbl_monsterXp.width > this.lbl_disabledMonsterList.width)))) && ((this.lbl_monsterXp.width > this.lbl_level.width))))
                                {
