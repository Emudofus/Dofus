package ui
{
   ...
   public class GuildMembers extends Object
   {
      ...
      public function updateGuildMemberLine(data:*, components:*, selected:Boolean) : void {
         ...
         var displayRightsMember:* = false;
         var selfPlayerItem:* = false;
         var sexString:String = null;
         ...
         if(data != null)
         {
            ...
            else if(memberInfo.connected == 1)
            {
            ...
            else if(memberInfo.connected != 2)
            {
