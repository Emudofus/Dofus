package ui
{
   ...
   public class Guild extends Object
   {
      ...
      public function onRelease(target:Object) : void {
         ...
         else if(target == this.btn_customization)
         {
            this.openSelectedTab(1);
         }
         else if(target == this.btn_taxCollector)
         {
            this.openSelectedTab(2);
         }
         else if(target == this.btn_paddock)
         {
            this.tx_paddockWarning.visible = false;
            this.openSelectedTab(3);
         }
         else if(target == this.btn_houses)
         {
