package ui
{
    ...
    public class MapInfo 
    {
        ...
        private function updateRewardsButtonVisibility():void
        {
            ...
            var gifts:* = this.playerApi.getWaitingGifts();
            if (((((rewards) && ((rewards.length > 0)))) || (((gifts) && ((gifts.length > 0))))))
            {
                this.btn_rewardsAndGifts.visible = true;
            }
            else
            {
                this.btn_rewardsAndGifts.visible = false;
            };
        }
        ...
        public function onTextureReady(pTexture:Texture):void
        {
            ...
            {
                if (pTexture == this.tx_allianceEmblemUp)
                {
        ...
        {
            if (target == this.btn_rewardsAndGifts)
            {
