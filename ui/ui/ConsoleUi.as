package ui
{
    ...
    public class ConsoleUi 
    {
        ...
        public function main(pShowConsole:Boolean):void
        {
            ...
            this.uiApi.addComponentHook(this.topBar, ComponentHookList.ON_RELEASE_OUTSIDE);
            this.uiApi.addComponentHook(this.topBar, ComponentHookList.ON_MOUSE_UP);
            this.uiApi.addComponentHook(this.redimCtr, ComponentHookList.ON_RELEASE_OUTSIDE);
            this.uiApi.addComponentHook(this.redimCtr, ComponentHookList.ON_MOUSE_UP);
            this.uiApi.addComponentHook(this.tx_resizeHandle, ComponentHookList.ON_PRESS);
            this.uiApi.addComponentHook(this.tx_resizeHandle, ComponentHookList.ON_RELEASE);
            this.uiApi.addComponentHook(this.tx_resizeHandle, ComponentHookList.ON_RELEASE_OUTSIDE);
            this.uiApi.addComponentHook(this.tx_resizeHandle, ComponentHookList.ON_MOUSE_UP);
        ...
        public function replaceComponent():void
        {
            ...
            this.tx_resizeHandle.x = ((this.redimCtr.width - this.tx_resizeHandle.width) - 4);
            this.tx_resizeHandle.y = (this.redimCtr.height - 4);
        ...
        {
            var boldLength:int;
            var serverCmd:Boolean;
            var possibilities:Object;
            var help:String;
            var historyContextMenu:Array;
            var historyPossibilities:Array;
            var contextMenu:Array;
            var cmdPos:uint;
            var sNewCmd:String;
            var splittedLine:Array;
            var currentCommand:String;
            var currentParams:Array;
            var entry:String;
            var cmd2:String;
            var boldStart:Number;
            var cmd3:String;
            var paramsAutoComplete:Array;
            var p:String;
            var paramPossibility:String;
            var possibility:String;
            var sStartCmd:String = this.tiCmd.text;
            var possibilitiesCount:uint;
            ...
            if (((((!(this._autoCompleteWithList)) && (!(isDeleting)))) && ((sStartCmd.length > 0))))
            {
                ...
                {
                    if (this._autoCompleteIndex < (this._autoCompletePossibilities.length - 1))
                    {
        ...
        public function onPress(target:Object):void
        {
            switch (target)
            {
                ...
                case this.tx_resizeHandle:
                    ...
                    this.tx_resizeHandle.startDrag();
                    break;
                case this.topBar:
        ...
        public function onRelease(target:Object):void
        {
            ...
            switch (target)
            {
                ...
                case this.btnMenu:
                    ...
                    _local_4 = [];
                    _local_5 = [];
                    this._menu.push(this.contextMod.createContextMenuItemObject("Opacity", null, null, false, _local_2));
                    _local_2.push(this.contextMod.createContextMenuItemObject("33%", this.onAlphaChange, [33], false, null, (this._options.opacity == 33)));
                    _local_2.push(this.contextMod.createContextMenuItemObject("66%", this.onAlphaChange, [66], false, null, (this._options.opacity == 66)));
                    _local_2.push(this.contextMod.createContextMenuItemObject("100%", this.onAlphaChange, [100], false, null, (this._options.opacity == 100)));
                    this.onAlphaChange(this._options.opacity);
                    this._menu.push(this.contextMod.createContextMenuItemObject("Font size", null, null, false, _local_3));
                    _local_3.push(this.contextMod.createContextMenuItemObject("14", this.onFontSizeChange, [14], false, null, (this._options.fontSize == 14)));
                    _local_3.push(this.contextMod.createContextMenuItemObject("16", this.onFontSizeChange, [16], false, null, (this._options.fontSize == 16)));
                    _local_3.push(this.contextMod.createContextMenuItemObject("20", this.onFontSizeChange, [20], false, null, (this._options.fontSize == 20)));
                    this._menu.push(this.contextMod.createContextMenuItemObject("Open console", null, null, false, _local_4));
                    _local_4.push(this.contextMod.createContextMenuItemObject("Manual", this.onOpenConsoleChange, [false], false, null, !(this._options.openConsole)));
                    _local_4.push(this.contextMod.createContextMenuItemObject("When receive message", this.onOpenConsoleChange, [true], false, null, this._options.openConsole));
                    this._menu.push(this.contextMod.createContextMenuItemObject("Autocomplete mode", null, null, false, _local_5));
                    _local_5.push(this.contextMod.createContextMenuItemObject("Show list", this.onChangeAutocomplete, [true], false, null, this._autoCompleteWithList));
                    _local_5.push(this.contextMod.createContextMenuItemObject("Command line", this.onChangeAutocomplete, [false], false, null, !(this._autoCompleteWithList)));
