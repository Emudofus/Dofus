package ui
{
   ...
   public class ItemNameTooltipUi extends Object
   {
      ...
      public function main(oParam:Object = null) : void {
         ...
         this._param = oParam;
         var displayItemToolTip:Boolean = (oParam.makerParam.hasOwnProperty("nameOnly")) && (!oParam.makerParam.nameOnly) || (!oParam.makerParam.hasOwnProperty("nameOnly")) && (Api.system.getOption("displayTooltips","dofus"));
