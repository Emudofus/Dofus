package ui
{
   ...
   public class AbstractStorageUi extends Object
   {
      ...
      protected static var _tabFilter:Dictionary;
      ...
      protected var _itemsDisplayed:Vector.<uint>;
      ...
      private function resumeTabState() : void {
         ...
         else if(!(this._currentCategoryFilter == ALL_CATEGORY))
         {
