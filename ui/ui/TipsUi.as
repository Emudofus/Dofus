package ui
{
    ...
    public class TipsUi 
    {
        ...
        private var _include_action_OpenSmileys:OpenSmileys;
        private var _include_action_OpenBook:OpenBook;
        ...
        private var _include_hook_OpenBook:OpenBook;
        ...
        private var _include_hook_OpenSmileys:OpenSmileys;
        ...
        {
            var _local_2:NotificationWrapper;
            var btn:Object;
            var action:Object;
            var hook:Class;
            switch (target)
            {
                ...
                default:
                    ...
                    _local_2 = this.getNotificationData((target as Texture));
                    if (_local_2)
                    {
                        if (_local_2 != this._currentTips)
                        {
                            this.uiApi.hideTooltip();
                            ...
                            this._currentTips = _local_2;
                            this.showMessage();
                        }
                        else
                        {
                            this.hideNotification(_local_2);
                        };
                        return;
                    };
            };
