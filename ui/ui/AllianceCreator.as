        ...
        public function onRelease(target:Object):void
        {
            ...
            switch (target)
            {
                ...
                case this.btn_create:
                    ...
                    {
                        if (((!((this._mode == EMBLEM_MODIFICATION))) && ((((this.inp_alliancetag.text.length < ProtocolConstantsEnum.MIN_ALLIANCETAG_LEN)) || ((this.inp_alliancetag.text.length > ProtocolConstantsEnum.MAX_ALLIANCETAG_LEN))))))
                        {
