package ui
{
    ...
    public class MountPaddock 
    {
        ...
        private function getPertinentFilter(dataProvider:Array, mountList:*=null, comboBoxRequester:ComboBox=null):Array
        {
            var mount:Object;
            var filter:Object;
            var pertinentFilter:Array = new Array();
        ...
        private function getCapacityAndModelFilterInBarn(dataProvider:*, checkSubFilter:Boolean=false, comboBoxRequester:ComboBox=null):Array
        {
            ...
            if (checkSubFilter)
            {
                ...
                if (this.cb_barn2)
                {
                    ...
                    {
                        if (this.cb_barn2.value.filterGroup == 5)
                        {
            ...
            if (comboBoxRequester)
            {
                ...
                {
                    if (comboBoxRequester.value.filterGroup == 5)
                    {
        ...
        {
            var paddockMount:Object;
            var barnMount:Object;
            ...
            else
            {
                if (target == this.gd_paddock)
                {
                    if (this.gd_paddock.selectedIndex != -1)
                    {
                        ...
                        {
                            if (this.gd_paddock.selectedItem)
                            {
                ...
                else
                {
                    if (target == this.gd_inventory)
                    {
                        if (this.gd_inventory.selectedIndex != -1)
                        {
                            ...
                            {
                                if (this.mountApi.isCertificateValid(this.gd_inventory.selectedItem))
                                {
                    ...
                    {
                        if ((((target == this.cb_barn)) && (isNewSelection)))
                        {
                            this.updateBarn(this.cb_barn.value.type, this.cb_barn2.value.type, this.cb_barn3.value.type);
                        }
                        else
                        {
                            if ((((target == this.cb_barn2)) && (isNewSelection)))
                            {
                                this.updateBarn(this.cb_barn.value.type, this.cb_barn2.value.type, this.cb_barn3.value.type);
                            }
                            else
                            {
                                if ((((target == this.cb_barn3)) && (isNewSelection)))
                                {
                                    this.updateBarn(this.cb_barn.value.type, this.cb_barn2.value.type, this.cb_barn3.value.type);
                                }
                                else
                                {
                                    if (target == this.cb_paddock)
                                    {
                                        this.updatePaddock(target.value.type);
                                    }
                                    else
                                    {
                                        if (target == this.cb_inventory)
                                        {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        if (target == this.btn_searchPaddock)
                                        {
                                        ...
                                        {
                                            if (target == this.btn_searchInventory)
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            {
                                                                if (target == this.btn_paddockType)
                                                                {
                                                                ...
                                                                {
                                                                    if (target == this.btn_paddockGender)
                                                                    {
                                                                    ...
                                                                    {
                                                                        if (target == this.btn_paddockName)
                                                                        {
                                                                        ...
                                                                        {
                                                                            if (target == this.btn_paddockLevel)
                                                                            {
                                                                            ...
                                                                            {
                                                                                if (target == this.btn_addFilter)
                                                                                {
                                                                                    this.showMoreFilter(true, target.name);
                                                                                }
                                                                                else
                                                                                {
                                                                                    if ((((((target == this.btn_removeFilter1)) || ((target == this.btn_removeFilter2)))) || ((target == this.btn_removeFilter3))))
                                                                                    {
        ...
        public function onKeyUp(target:Object, keyCode:uint):void
        {
            ...
            {
                if (this.lbl_searchPaddock.haveFocus)
                {
                    this.updatePaddock(this.cb_paddock.value.type);
                }
                else
                {
                    if (this.lbl_searchInventory.haveFocus)
                    {
                        this.updateInventory(this.cb_inventory.value.type);
                    };
                };
