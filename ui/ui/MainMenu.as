package ui
{
    ...
    public class MainMenu 
    {
        ...
        {
            var char:BasicCharacterWrapper;
            var serverId:int;
        ...
        public function onRollOver(target:Object):void
        {
            switch (target)
            {
                ...
                case this.tx_hourglass:
                    this.uiApi.showTooltip(this.uiApi.textTooltipInfo(this.uiApi.getText("ui.common.serverstatus.saving")), target, false, "standard", LocationEnum.POINT_RIGHT, LocationEnum.POINT_LEFT, 0, null, null, null, "TextInfo");
                    break;
            };
        }
        ...
        private function updateCharacterChangeAvailability():void
        {
            ...
            var isServerSaving:Boolean = (this.sysApi.getServerStatus() == ServerStatusEnum.SAVING);
