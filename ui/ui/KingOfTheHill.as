package ui
{
    ...
    public class KingOfTheHill 
    {
        ...
        private static const TIME_UNLOAD_AFTER_END:uint = (1000 * 60);//60000
        ...
        private static const TEAM_ATTACKER_COLOR:uint = 0xFF0000;
        ...
        private var _kohPlayerStatus:uint = 0xFFFFFFFF;
        ...
        {
            var alliance:AllianceOnTheHillWrapper;
            var color:uint;
            var bar:Bar;
            var width:int;
            var allianceId:*;
            ...
            for each (alliance in this._alliances)
            {
                ...
                if (!(bar))
                {
                    ...
                    {
                        if (alliance.allianceId == this._prismAllianceId)
                        {
        ...
        {
            var alliance:AllianceOnTheHillWrapper;
            var mapInfos:WorldPointWrapper;
            var winnerTagText:String;
            var winnerScoreText:String;
            var myTagAndScoreText:String;
            var ts:Number;
            ...
            {
                if (allianceMapWinner.allianceTag == "")
                {
                    winnerTagText = "";
            ...
            if (((!((allianceMapWinner.allianceId == this._myAllianceId))) && ((allianceMapWinnerScore > 0))))
            {
                ...
                (((allianceMapMyAllianceScore + " ") + this.uiApi.getText("ui.short.points")) + ")");
        ...
        public function onRollOver(target:Object):void
        {
            ...
            var data:AllianceOnTheHillWrapper;
            var point:uint = 6;
            var relPoint:uint;
            switch (true)
            {
                case !((target.name.indexOf("tx_type") == -1)):
                    ...
                    tooltipText = this.uiApi.getText((((this._myAllianceId == data.allianceId)) ? "ui.alliance.myAlliance" : ((((this._prismAllianceId == data.allianceId)) ? "ui.alliance.allianceInDefense" : ("ui.alliance.allianceInAttack")))));
                    break;
...
class Bar 
{
    ...
    public function Bar(uiApi:UiApi)
    {
