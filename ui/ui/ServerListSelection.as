package ui
{
   ...
   public class ServerListSelection extends Object
   {
      ...
      private function validateServerChoice() : void {
         var selectedServer:Object = null;
         if((this._aServers) && (this.gd_listServer.selectedItem))
         {
            ...
            this.sysApi.sendAction(new d2actions.ServerSelection(selectedServer.id));
      ...
      private function startSearch() : void {
         ...
         else if((!(searchName.length < 2)) && (searchName.length <= 30) && (!this.btn_friendSearch.disabled))
         {
