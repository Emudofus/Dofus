package d2components
{
    public class MapViewer extends GraphicContainer 
    {
        ...
        public function addIcon(layer:String, id:String, uri:*, x:int, y:int, scale:Number=1, legend:String=null, follow:Boolean=false, color:int=-1, canBeGrouped:Boolean=true, canBeManuallyRemoved:Boolean=true):Object
        {
            return (null);
        }
