...
{
    public class ComboBox extends GraphicContainer 
    {


        public function get listSizeOffset():uint
        {
            return (new uint());
        }

        public function set listSizeOffset(v:uint):void
        {
        }
        ...
        public function set buttonTexture(uri:Object):void
        {
        }

        public function get buttonTexture():Object
        {
            return (null);
        }

        public function set listTexture(uri:Object):void
        {
        }

        public function get listTexture():Object
        {
            return (null);
        }
        ...
        public function set scrollBarCss(uri:Object):void
        {
        }

        public function get scrollBarCss():Object
        {
            return (null);
        }
