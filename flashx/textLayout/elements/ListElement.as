package flashx.textLayout.elements
{
   ...
   public class ListElement extends ContainerFormattedElement
   {
      ...
      private static const romanDigitFunction:Vector.<Function> = Vector.<Function>([new function(o:String, f:String, t:String):String
                                                                        {
                                                                        return "";
                                                                        },new function(o:String, f:String, t:String):String
                                                                        {
                                                                        return o;
                                                                        },new function(o:String, f:String, t:String):String
                                                                        {
      ...
      tlf_internal  static function upperRomanString(n:int) : String {
         ...
         while(n>=10000)
         {
            highString=highString+String.fromCharCode(8578);
            n=n-10000;
         }
         if(n==9000)
         {
            highString=highString+("M"+String.fromCharCode(8578));
         }
         else
         {
            if(n==4000)
            {
               highString=highString+("M"+String.fromCharCode(8577));
            }
            else
            {
               if(n>=5000)
               {
                  highString=highString+String.fromCharCode(8577);
                  n=n-5000;
               }
               while(n>0)
               {
                  highString=highString+"M";
                  n=n-1000;
               }
            }
         }
      ...
      tlf_internal function computeListItemTextSpecified(child:ListItemElement, listMarkerFormat:IListMarkerFormat, listStyleType:String, suffixOverride:String) : String {
         ...
         else
         {
            ...
            {
               rslt=rslt+suffixOverride;
            }
            else
            {
               if(listMarkerFormat.suffix!=Suffix.NONE)
               {
                  rslt=rslt+listSuffixes[listStyleType];
               }
            }
         }
         return rslt;
