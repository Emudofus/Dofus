...
// [Initial MovieClip Action of sprite 20579]
#initclip 100
if (!dofus.graphics.gapi.ui.PopupHexa)
{
    if (!dofus)
    {
    ...
    var _loc1 = (_global.dofus.graphics.gapi.ui.PopupHexa = function ()
    {
        super();
    }).prototype;
    ...
    _loc1.initWindowContent = function ()
    {
        ...
        _loc2._tiInput.restrict = "0-9 A-F";
        _loc2._tiInput.maxChars = 6;
    ...
    (_global.dofus.graphics.gapi.ui.PopupHexa = function ()
    {
        super();
    }).CLASS_NAME = "PopupHexa";
    _loc1._nValue = "000000";
