...
if (!dofus.graphics.gapi.ui.Options)
{
    ...
    _loc1.initData = function ()
    {
        ...
        this._mcTabViewer._btnMovableBar.selected = _loc2.getOption("MovableBar");
        this._mcTabViewer._vsMovableBarSize.value = _loc2.getOption("MovableBarSize");
        this._mcTabViewer._lblMovableBarSizeValue.text = _loc2.getOption("MovableBarSize");
    ...
    _loc1.change = function (oEvent)
    {
        switch (oEvent.target._name)
        {
            ...
            {
                var _loc3 = Math.floor(oEvent.target.value);
                this.api.kernel.OptionsManager.setOption("MovableBarSize", _loc3);
                this._mcTabViewer._lblMovableBarSizeValue.text = _loc3.toString();
                break;
            } 
        } // End of switch
    };
