...
// [Initial MovieClip Action of sprite 20885]
#initclip 150
if (!dofus.graphics.gapi.ui.BigStoreSearch)
{
    ...
    var _loc1 = (_global.dofus.graphics.gapi.ui.BigStoreSearch = function ()
    {
        super();
    }).prototype;
    ...
    _loc1.generateIndexes = function ()
    {
        ...
        for (var k in _loc3)
        {
            ...
            if (_loc2[_loc4.t] && (_loc4.h != true && _loc4.l <= this._nMaxLevel))
            {
                var _loc5 = _loc4.n;
                this._aItems.push({id: k, name: _loc5.toUpperCase()});
            } // end if
        } // end of for...in
    };
    _loc1.searchItem = function (sText)
    {
        ...
        this._lblSearchCount.text = _loc4.length == 0 ? (this.api.lang.getText("NO_BIGSTORE_SEARCH_RESULT")) : (_loc4.length + " " + ank.utils.PatternDecoder.combine(this.api.lang.getText("OBJECTS"), "m", _loc4 < 2));
    ...
    _loc1.click = function (oEvent)
    {
        switch (oEvent.target._name)
        {
            ...
            case "_btnView":
            {
                ...
                this.api.network.Exchange.bigStoreSearch(_loc3.type, _loc3.unicID);
                break;
            } 
        } // End of switch
    };
    ...
    (_global.dofus.graphics.gapi.ui.BigStoreSearch = function ()
    {
        super();
    }).CLASS_NAME = "BigStoreSearch";
    _loc1._sDefaultText = "";
} // end if
#endinitclip
